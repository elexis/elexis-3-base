...
public class ClusterProperties {
	 ...
	 * Read the value of a cluster property, returning a default if it is not set
	 *
	 * @param key          the property name or the full path to the property as a
	 *                     list of parts.
	 * @param defaultValue the default value
	 * @param <T>          the type of the property
	 * @return the property value
	...
	public Map<String, Object> getClusterProperties() throws IOException {
		try {
			Map<String, Object> properties = (Map<String, Object>) Utils
					.fromJSON(client.getData(ZkStateReader.CLUSTER_PROPS, null, new Stat(), true));
	...
	public void setClusterProperties(Map<String, Object> properties)
	...
	/**
	 * See SOLR-12827 for background. We auto convert any "collectionDefaults" keys
	 * to "defaults/collection" format. This method will modify the given map and
	 * return the same object. Remove this method in Solr 9.
	 *
	 ...
	 * @param propertyValue The value of the property, could also be a nested
	 *                      structure.
	 ...
	 * 1. <code>ZkStateReader.KNOWN_CLUSTER_PROPS</code> that is used by solr
	 * itself.<br/>
	 * 2. Custom property: it can be created by third-party extensions and should
	 * start with prefix <b>"ext."</b> and it's recommended to also add prefix of
	 * plugin name or company name or package name to avoid conflict.
	 *
	...
	private void validatePropertyName(String propertyName) {
		if (!ZkStateReader.KNOWN_CLUSTER_PROPS.contains(propertyName)
			...
			throw new SolrException(SolrException.ErrorCode.BAD_REQUEST,
					"Not a known cluster property or starts with prefix " + EXT_PROPRTTY_PREFIX + ", propertyName: "
							+ propertyName);
		}
	}
}
