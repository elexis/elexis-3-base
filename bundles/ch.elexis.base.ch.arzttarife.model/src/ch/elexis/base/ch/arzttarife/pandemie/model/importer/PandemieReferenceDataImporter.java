...
public class PandemieReferenceDataImporter extends AbstractReferenceDataImporter implements IReferenceDataImporter {
	...
	public IStatus performImport(@Nullable IProgressMonitor monitor, InputStream input, @Nullable Integer newVersion) {
		...
		exw.setFieldTypes(new Class[] { String.class /* tarifcode */, String.class /* pandemie */,
				String.class /* kapitel */, String.class /* unterkapitel */, String.class /* ziffer */,
				String.class /* leistung */, String.class /* interpretation */, String.class /* part-og */,
				Integer.class /* anzahl */, String.class /* kumultation einsch. */, String.class /* kumulation */,
				String.class /* limitation */, String.class /* tp oder chf */, Double.class /* wert */,
				TimeTool.class /* gülti ab */, TimeTool.class /* gülti bis */
		});
		if (exw.load(input, 0)) {
			...
			for (int i = 0; i < last; i++) {
				...
				List<PandemieLeistung> existing = getExisting(line.get(1), line.get(4), getValidFrom(line));
				if (!existing.isEmpty()) {
