...
public class UnoUtil {
	 ...
	 */
	public static void setPrinterTray(XTextDocument doc, String tray)
		...
		XNameContainer xFamily =
			(XNameContainer) UnoRuntime.queryInterface(XNameContainer.class, xFamilies
		...
		try {
			...
			throw new IllegalArgumentException(
				"Could not set Tray to " + tray + " try " + possible);
		}
	}
	 ...
	 * @throws WrappedTargetException
	 */
	public static void setFormat(final XTextCursor xtc, final String fontName,
		final float fontSize, final int fontStyle, final int adjust)
	 ...
	 */
	public static void setFormat(final XTextCursor xtc, final String fontName,
		final float fontSize, final int fontStyle) throws UnknownPropertyException,
