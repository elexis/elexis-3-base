...
public class OmnivoreDocumentStore implements IDocumentStore {
	...
	public void removeDocument(IDocument document) {
		Optional<IDocumentHandle> existing = modelService.load(document.getId(), IDocumentHandle.class);
	...
	public IDocument createDocument(String patientId, String title, String categoryName) {
		...
		ICategory iCategory = categoryName != null ? new TransientCategory(categoryName) : getCategoryDefault();
