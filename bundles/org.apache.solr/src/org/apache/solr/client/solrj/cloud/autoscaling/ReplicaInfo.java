...
public class ReplicaInfo implements MapWriter {
	...
	public ReplicaInfo(String name, String core, String coll, String shard, Replica.Type type, String node,
	...
	public void writeMap(EntryWriter ew) throws IOException {
		...
		ew.put(name, (MapWriter) ew1 -> {
			ew1.put(ZkStateReader.CORE_NAME_PROP, core, p).put(ZkStateReader.SHARD_ID_PROP, shard, p)
					.put(ZkStateReader.COLLECTION_PROP, collection, p).put(ZkStateReader.NODE_NAME_PROP, node, p)
	...
	public boolean equals(Object o) {
		...
		if (name.equals(other.name) && collection.equals(other.collection) && core.equals(other.core)
				&& isLeader == other.isLeader && node.equals(other.node) && shard.equals(other.shard)
				&& type == other.type && variables.equals(other.variables)) {
			return true;
		} else {
			return false;
		}
