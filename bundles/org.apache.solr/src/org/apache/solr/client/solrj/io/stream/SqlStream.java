...
public class SqlStream extends TupleStream implements Expressible {
	 ...
	 *                     <p>
	 *                     This form does not allow specifying multiple clauses, say
	 *                     "fq" clauses, use the form that takes a SolrParams.
	 *                     Transition code can call the preferred method that takes
	 *                     SolrParams by calling CloudSolrStream(zkHost,
	 *                     collectionName, new
	 *                     ModifiableSolrParams(SolrParams.toMultiMap(new
	 *                     NamedList(Map&lt;String, String&gt;)));
	 */
