...
public class GastroComposite extends CstComposite {
	...
	private void createLayout(Composite parent) {
		...
		// 1 B
		cdtGastroDatum = new CDateTime(parent, CDT.BORDER | CDT.DROP_DOWN | CDT.DATE_MEDIUM | CDT.TEXT_TRAIL);
		...
		cdtColoDatum = new CDateTime(parent, CDT.BORDER | CDT.DROP_DOWN | CDT.DATE_MEDIUM | CDT.TEXT_TRAIL);
