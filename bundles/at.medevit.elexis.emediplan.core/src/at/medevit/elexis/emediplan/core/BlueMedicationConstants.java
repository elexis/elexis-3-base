...
public class BlueMedicationConstants {
	public static final String CFG_URL_STAGING =
		"at.medevit.elexis.emediplan/bluemedication/staging"; //$NON-NLS-1$
	public static final String CFG_USE_IMPORT =
		"at.medevit.elexis.emediplan/bluemedication/useimport"; //$NON-NLS-1$
