...
/**
 * Single threaded buffered OutputStream Internal Solr use only, subject to
 * change.
 */
public class FastOutputStream extends OutputStream implements DataOutput {
	...
	/**
	 * reserve at least len bytes at the end of the buffer. Invalid if len &gt;
	 * buffer.length
	 */
	...
	/**
	 * Only flushes the buffer of the FastOutputStream, not that of the underlying
	 * stream.
	 */
	...
	/**
	 * Returns the number of bytes actually written to the underlying OutputStream,
	 * not including anything currently buffered by this class itself.
	 */
	public long written() {
		return written;
	}
