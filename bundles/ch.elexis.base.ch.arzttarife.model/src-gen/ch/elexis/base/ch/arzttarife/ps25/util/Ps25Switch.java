 ...
 * @generated
 */
public class Ps25Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Ps25Package.IPS25_LEISTUNG: {
				IPs25Leistung iPs25Leistung = (IPs25Leistung)theEObject;
				T result = caseIPs25Leistung(iPs25Leistung);
				if (result == null) result = caseIBillable(iPs25Leistung);
				if (result == null) result = caseICodeElement(iPs25Leistung);
				if (result == null) result = caseIdentifiable(iPs25Leistung);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>IPs25 Leistung</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>IPs25 Leistung</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIPs25Leistung(IPs25Leistung object) {
		return null;
	}
