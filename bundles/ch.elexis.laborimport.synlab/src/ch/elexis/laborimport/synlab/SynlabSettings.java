...
public class SynlabSettings {
	...
	public static final String CFG_PATHS_GLOBAL = "synlab/paths_global"; //$NON-NLS-1$

	private SynlabSettings() {
	}
	...
	public static Optional<File> resolveLocalFile(String pathOrUri) {
		...
		try {
			...
			LoggerFactory.getLogger(SynlabSettings.class).debug(
