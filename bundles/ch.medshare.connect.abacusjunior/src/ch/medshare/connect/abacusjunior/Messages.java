...
public class Messages {
	...
	public static String AbacusJuniorAction_DefaultParams = ch.elexis.core.l10n.Messages.Baud_115k_8n1;
	...
	public static String AbacusJuniorAction_LogError_Title = ch.elexis.core.l10n.Messages.Core_Error_with_logfile;
	public static String AbacusJuniorAction_LogError_Text = ch.elexis.core.l10n.Messages.AbacusJuniorAction_LogError_Text;
	public static String AbacusJuniorAction_Patient_Title = ch.elexis.core.l10n.Messages.Core_Select_Patient;
	public static String AbacusJuniorAction_Patient_Text = ch.elexis.core.l10n.Messages.AbacusJuniorAction_Patient_Text;
	public static String AbacusJuniorAction_RS232_Error_Title = ch.elexis.core.l10n.Messages.Core_Error_with_port;
	public static String AbacusJuniorAction_RS232_Error_Text = ch.elexis.core.l10n.Messages.Core_Unable_to_open_com_port;
	public static String AbacusJuniorAction_RS232_Break_Title = ch.elexis.core.l10n.Messages.Core_Error_with_device;
	public static String AbacusJuniorAction_RS232_Break_Text = ch.elexis.core.l10n.Messages.Core_Data_RS232_Break;
	public static String AbacusJuniorAction_RS232_Timeout_Title = ch.elexis.core.l10n.Messages.Core_Error_with_device;
	public static String AbacusJuniorAction_RS232_Timeout_Text = ch.elexis.core.l10n.Messages.Core_Device_Timout;
	...
	public static String AbacusJunior_Value_Error = ch.elexis.core.l10n.Messages.Core_Error_while_measuring;
