...
public class EditVaccinationDialog extends TitleAreaDialog {
	...
	FieldDescriptor<VaccinationType>[] fields = new FieldDescriptor[] {
			new FieldDescriptor<VaccinationType>(Messages.EditVaccinationDialog_nameOfVaccination, VaccinationType.NAME,
					FieldDescriptor.Typ.STRING, null),
			...
			new FieldDescriptor<VaccinationType>(Messages.EditVaccinationDialog_distance1_2, VaccinationType.DELAY1TO2,
					null),
			new FieldDescriptor<VaccinationType>(Messages.EditVaccinationDialog_distance2_3, VaccinationType.DELAY2TO3,
					null),
			new FieldDescriptor<VaccinationType>(Messages.EditVaccinationDialog_distance3_4, VaccinationType.DELAY3TO4,
					null),
