...
public class XML45Printer {
	...
	private EZPrinter.EZPrinterData getEZPrintData(Balance45Adapter balance, ServicesType services,
		BodyType body){
	...
	public boolean doPrint(Rechnung rn, Document xmlRn, TYPE rnType, String saveFile,
		...
		Balance45Adapter balance =
			body.getTiersGarant() != null ? new Balance45Adapter(body.getTiersGarant().getBalance())
		...
		SortedList<Object> serviceRecordsSorted =
			new SortedList<Object>(serviceRecords, new Rn45Comparator());
		...
		for (Object obj : serviceRecordsSorted) {
			...
			if (cmAvail <= cmPerLine) {
				...
				XMLPrinterUtil.insertPage(TarmedTemplateRequirement.TT_TARMED_45_S2, ++page,
					adressat, rn, xmlRn,
	...
	private void addSubTotalLine(Object cursor, ITextPlugin tp, Balance45Adapter balance,
		String tcCode,
		ESR esr){
	...
	private String getRecordServiceString(ServiceType rec, StringBuilder sb,
	...
	private String getTarmedRecordString(ServiceExType tarmed, StringBuilder sb,
		HashMap<String, String> eanMap){
	...
	private void addBalanceLines(Object cursor, ITextPlugin tp, Balance45Adapter balance,
		Money paid){
