...
public class PreferenceConstants {
	public static final String USETC = "TarmedUseTC"; //$NON-NLS-1$
	public static final String TARMEDTC = "TarmedTC"; //$NON-NLS-1$
	public static final String USEEDA = "TarmedUseEDa"; //$NON-NLS-1$
