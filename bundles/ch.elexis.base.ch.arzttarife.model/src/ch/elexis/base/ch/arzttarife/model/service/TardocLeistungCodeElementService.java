...
@Component
public class TardocLeistungCodeElementService implements ICodeElementServiceContribution, IStoreToStringContribution {
	...
	public String getSystem() {
		return TardocConstants.TardocLeistung.CODESYSTEM_NAME;
	}
	...
	public Optional<String> storeToString(Identifiable identifiable) {
		if (identifiable instanceof TardocLeistung) {
			return Optional.of(ch.elexis.base.ch.arzttarife.tardoc.model.TardocLeistung.STS_CLASS
	...
	public Optional<Identifiable> loadFromString(String storeToString) {
		if (storeToString.startsWith(
				ch.elexis.base.ch.arzttarife.tardoc.model.TardocLeistung.STS_CLASS + StringConstants.DOUBLECOLON)) {
			String[] split = splitIntoTypeAndId(storeToString);
			String id = split[1];
			EntityManager em = (EntityManager) entityManager.getEntityManager();
			EntityWithId dbObject = em.find(ch.elexis.core.jpa.entities.TardocLeistung.class, id);
	...
	public Class<?> getEntityForType(String type) {
		if (ch.elexis.base.ch.arzttarife.tardoc.model.TardocLeistung.STS_CLASS.equals(type)) {
			return ch.elexis.core.jpa.entities.TardocLeistung.class;
		}
		return null;
	}
	...
	public String getTypeForEntity(Object entityInstance) {
		if (entityInstance instanceof ch.elexis.core.jpa.entities.TardocLeistung) {
			return ch.elexis.base.ch.arzttarife.tardoc.model.TardocLeistung.STS_CLASS;
		}
		return null;
	}
