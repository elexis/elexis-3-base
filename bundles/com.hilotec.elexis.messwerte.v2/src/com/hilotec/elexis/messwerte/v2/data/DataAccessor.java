...
public class DataAccessor implements IDataAccess {
	...
	public List<Element> getList() {
		...
		for (MessungTyp typ : config.getTypes()) {
			ret.add(new IDataAccess.Element(IDataAccess.TYPE.STRING, typ.getName(), getPlatzhalter(typ), Patient.class,
					1));
		}
		return ret;
	}
	 ...
	 *
	 * @param suchbegriff Entweder ein Datum, "first" fuer die aelteste Messung oder
	 *                    "last" fuer die Neuste.
	 */
