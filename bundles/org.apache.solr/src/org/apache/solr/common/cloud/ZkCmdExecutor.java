...
public class ZkCmdExecutor {
	...
	/**
	 * TODO: At this point, this should probably take a SolrZkClient in its
	 * constructor.
	 *
	 * @param timeoutms the client timeout for the ZooKeeper clients that will be
	 ...
	 */
	public <T> T retryOperation(ZkOperation<T> operation) throws KeeperException, InterruptedException {
	...
	public void ensureExists(final String path, final byte[] data, CreateMode createMode, final SolrZkClient zkClient,
			int skipPathParts) throws KeeperException, InterruptedException {
