 ...
 * @generated
 */
public class PsychoAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected PsychoSwitch<Adapter> modelSwitch =
		new PsychoSwitch<Adapter>() {
			@Override
			public Adapter caseIPsychoLeistung(IPsychoLeistung object) {
				return createIPsychoLeistungAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ch.elexis.base.ch.arzttarife.psycho.IPsychoLeistung <em>IPsycho Leistung</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createIPsychoLeistungAdapter() {
		return null;
	}
