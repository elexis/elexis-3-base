...
public class CobasMiraMessage {
	...
	private LinkedList<CobasMiraPatientResult> patientResults =
		new LinkedList<CobasMiraPatientResult>();
	...
	public void setHeader(String in){
		try {
			...
			logger.debug("HEADER instrumentCode/sysId/blockType: " + instrumentCode + "/"
				+ systemIdentification + "/" + blockType);
