 ...
 * {@link org.apache.solr.client.solrj.SolrClient}. To use this class, the
 * solrconfig.xml for the relevant core must include the request handler for
 * <code>/admin/ping</code>.
 *
 * @since solr 1.3
 */
public class SolrPing extends SolrRequest<SolrPingResponse> {
	 ...
	 * behavior as {@code SolrPing#setActionPing()}. For Solr server version 4.0 and
	 * later.
	 *
	 * @return this
	 */
