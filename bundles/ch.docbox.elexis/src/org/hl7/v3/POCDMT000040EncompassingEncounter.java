...
@XmlType(name = "POCD_MT000040.EncompassingEncounter", propOrder = {
	"realmCode", "typeId", "templateId", "id", "code", "effectiveTime", "dischargeDispositionCode",
	"responsibleParty", "encounterParticipant", "location"
})
public class POCDMT000040EncompassingEncounter {
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any
	 * modification you make to the returned list will be present inside the JAXB object. This is
	 * why there is not a <CODE>set</CODE> method for the encounterParticipant property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
