...
public interface IHL7MessageService {
	...
	/**
	 * Test if the context contains the objects needed to create the message. The returned List
	 * contains the missing keys (e.g. {@link IHL7MessageService#CONTEXT_PATIENT}), or empty if the
	 * context is valid.
	 * 
	 * @param messageTyp
	 * @param context
