...
public interface InteractionPortType {
     ...
     * @return
     *     returns https.www_pharmedsolutions_ch.interactionservice.Interactions
     */
    ...
    public Interactions checkInteraction(
        @WebParam(name = "InteractionRequest", targetNamespace = "https://www.pharmedsolutions.ch/InteractionService", partName = "interactionrequest")
