...
public abstract class AbstractDatasetCreator extends Job {
	...
	/**
	 * Creates the content for this dataset creator. Subclasses need to implement
	 * this method and do their main work in here - create the dataset.
	 *
	...
	/**
	 * Method to work around the incapability of finding out whether the dataset has
	 * any data in it or not. The method returns <code>false</code> by default so
	 * that even empty dataset get rendered. If a subclass overrides this method,
	 * other objects can check for it and e.g. display a warning or information
	 * message instead of an empty graph.
	 *
