...
public class DomainMap extends HashMap<String, Object> {
	 ...
	 *
	 * May be called multiple times. Each added filter is retained and used to
	 * narrow the domain.
	 */
	 ...
	 *
	 * May be called multiple times. Each specified query is retained and included
	 * in the domain.
	 */
	...
	/**
	 * Provide a tag or tags that correspond to filters or queries to exclude from
	 * the domain
	 *
	 * May be called multiple times. Each exclude-string is retained and used for
	 * removing queries/filters from the domain specification.
	 *
	 * @param excludeTagsValue a comma-delimited String containing filter/query tags
	 *                         to exclude
	 */
	...
	/**
	 * Indicates that the resulting domain will contain all parent documents of the
	 * children in the existing domain
	 *
	 * @param allParentsQuery a query used to identify all parent documents in the
	 *                        collection
	 */
	...
	/**
	 * Indicates that the resulting domain will contain all child documents of the
	 * parents in the current domain
	 *
	 * @param allChildrenQuery a query used to identify all child documents in the
	 *                         collection
	 */
	...
	/**
	 * Transforms the domain by running a join query with the provided {@code from}
	 * and {@code to} parameters
	 *
	 * Join modifies the current domain by selecting the documents whose values in
	 * field {@code to} match values for the field {@code from} in the current
	 * domain.
	 *
	 * @param from a field-name whose values are matched against {@code to} by the
	 *             join
	 * @param to   a field name whose values should match values specified by the
	 *             {@code from} field
	 */
