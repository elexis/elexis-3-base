...
/**
 * An equality field Equalitor which compares a field of two Tuples and
...
public class FieldEqualitor implements StreamEqualitor {
	...
	public Explanation toExplanation(StreamFactory factory) throws IOException {
		return new Explanation(equalitorNodeId.toString()).withExpressionType(ExpressionType.EQUALITOR)
