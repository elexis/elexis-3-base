...
public class NutritionLeistungCodeElementService
	...
	public Optional<ICodeElement> loadFromCode(String code, Map<Object, Object> context){
		...
		TypedQuery<NutritionLeistung> gtinQuery =
			em.createNamedQuery("NutritionLeistung.code", NutritionLeistung.class);
	...
	public Optional<Identifiable> loadFromString(String storeToString){
		if (storeToString
			.startsWith(ch.elexis.base.ch.arzttarife.nutrition.model.NutritionLeistung.STS_CLASS
				+ StringConstants.DOUBLECOLON)) {
	...
	public List<Identifiable> loadFromStringWithIdPart(String partialStoreToString){
		...
		if (split != null && split.length == 2) {
			...
			Class<? extends EntityWithId> clazz =
				ch.elexis.core.jpa.entities.NutritionLeistung.class;
			EntityManager em = (EntityManager) entityManager.getEntityManager();
