...
public class GDTSatzNachricht {
	 ...
	 * Felder SATZIDENTIFIKATION, GDT_ID_EMPFÄNGER, GDT_ID_SENDER, VERWENDETER
	 * ZEICHENSATZ, GDT VERSION
	 *
	 ...
	 */
	public GDTSatzNachricht(int satzart, String gdtIdReceiver, String gdtIdSender, String zeichensatz,
			String gdtVersion) {
	...
	/**
	 * If a value for the key feldkennung can be resolved (i.e. != null), add it to
	 * the message
	 *
	 * @param feldkennung
	 */
	protected void ifSetAddLine(int feldkennung) {
		added.add(feldkennung);
		if (values.get(feldkennung) != null)
			addLine(feldkennung);
	 ...
	 * @return returns the value to which the specified key is mapped, or null if
	...
	/**
	 * Erstellt eine Textnachricht aus dem gewählten Typ und liefert diese als
	 * String Array
	 *
	 * @return
	 */
	...
	/**
	 * Set true if additional values have been set and should be included in the
	 * message.
	 *
	 * @param value
	 */
