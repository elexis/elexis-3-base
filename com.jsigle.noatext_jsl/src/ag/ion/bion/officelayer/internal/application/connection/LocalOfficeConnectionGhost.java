...
public class LocalOfficeConnectionGhost implements OfficeConnection {
    ...
    System.out.println("LocalOfficeConnection: LocalOfficeConnectionGhost.getComponentContext() begin");
	  	  
		if (officeProgressMonitor != null)
			if (officeProgressMonitor.isCanceled())
				return null;

    System.out.println("LocalOfficeConnection: LocalOfficeConnectionGhost.getComponentContext() about to connect");

		if (context == null)
			context = connect();

    System.out.println("LocalOfficeConnection: LocalOfficeConnectionGhost.getComponentContext() about to return");
		return context;
	}
	...
	private XComponentContext connect() {
		System.out.println("LocalOfficeConnectionGhost.connect() begin");
		...
		try {
			...
			boolean isLibreOffice = isLibreOffice(programPath);
      			...
      			System.out.println("LocalOfficeConnection.Ghost.connect(): getting new BootstrapSocketConnector()...");
      			System.out.println("LocalOfficeConnection.Ghost.connect(): programPath:   "+programPath);
      			System.out.println("LocalOfficeConnection.Ghost.connect(): isLibreOffice: "+isLibreOffice);
			...
			String unoConnectString = "uno:socket," + hostAndPort
      			...
      			System.out.println("LocalOfficeConnection.Ghost.connect(): bootstrapSocketConnector.connect()...");
      			System.out.println("LocalOfficeConnection.Ghost.connect(): hostAndPort:      "+hostAndPort);
      			System.out.println("LocalOfficeConnection.Ghost.connect(): oooAcceptOption:  "+oooAcceptOption);
      			System.out.println("LocalOfficeConnection.Ghost.connect(): unoConnectString: "+unoConnectString);

			XComponentContext xContext = bootstrapSocketConnector.connect(
					oooAcceptOption, unoConnectString);

      			System.out.println("LocalOfficeConnection.Ghost.connect(): bootstrapSocketConnector.connect() returned");
      			System.out.println("LocalOfficeConnection.Ghost.connect(): result: xContext: "+xContext.toString());
	...
	System.out.println("LocalOfficeConnectionGhost: loadNativeLibraries() begin");
      	  
		String officeHomePath = System.getProperty("office.home"); //$NON-NLS-1$

    if (officeHomePath==null)	System.out.println("LocalOfficeConnectionGhost: officeHomePath==null");
    else						System.out.println("LocalOfficeConnectionGhost: officeHomePath="+officeHomePath.toString());


    
		if (OSHelper.IS_WINDOWS) {

      System.out.println("LocalOfficeConnectionGhost: OSHelper.IS_WINDOWS");
    	
			try {
    	  
        System.out.println("LocalOfficeConnectionGhost: about to load msvcr70...");
        	...
        	System.out.println("LocalOfficeConnectionGhost: "+officeHomePath + File.separator+ "program"+ File.separator+ System.mapLibraryName("msvcr70"));  
			...
			try {
        System.out.println("LocalOfficeConnectionGhost: about to load msvcr71...");
        	...
        	System.out.println("LocalOfficeConnectionGhost: "+officeHomePath + File.separator+ "program"+ File.separator+ System.mapLibraryName("msvcr71"));  
			...
			try {
        System.out.println("LocalOfficeConnectionGhost: about to load uwinapi...");
          	...
          	System.out.println("LocalOfficeConnectionGhost: "+officeHomePath + File.separator+ "program"+ File.separator+ System.mapLibraryName("uwinapi"));  
			...
			try {
        System.out.println("LocalOfficeConnectionGhost: about to load jawt...");
            ...
            System.out.println("LocalOfficeConnectionGhost: "+officeHomePath + File.separator+ "program"+ File.separator+ System.mapLibraryName("jawt"));  
		...
		try {
      System.out.println("LocalOfficeConnectionGhost: about to load officebean...");
          ...
          System.out.println("LocalOfficeConnectionGhost: "+officeHomePath + File.separator+ "program"+ File.separator+ System.mapLibraryName(OFFICE_LIB_NAME));  
    ...
    System.out.println("LocalOfficeConnectionGhost: loadNativeLibraries() end");
	}
	// ----------------------------------------------------------------------------
