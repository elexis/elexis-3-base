 ...
 * This is a per-node-per-snitch instance.
 */
public abstract class SnitchContext implements RemoteCallback {
	...
	/**
	 * make a call to solrnode/admin/cores with the given params and give a
	 * callback. This is designed to be asynchronous because the system would want
	 * to batch the calls made to any given node
	 *
	 ...
	 * @param callback The callback to be called when the response is obtained from
	 *                 remote node. If this is passed as null the entire response
	 *                 map will be added as tags
	 */
	@Deprecated
