...
public class Messages{
    ...
    public static String InvoiceOutputter_InvoiceOutputDir = ch.elexis.core.l10n.Messages.Invoice_Please_Select_Output_Directory;
    ...
    public static String Preferences_Password = ch.elexis.core.l10n.Messages.Core_Password;
    ...
    public static String Preferences_Username = ch.elexis.core.l10n.Messages.Benutzer_Name;
