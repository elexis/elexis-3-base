 ...
 * hand, the creation of request parameters for creating new fields or field
 * types can be tedious because it is not strongly typed (the user has to build
 * on his own a {@link NamedList} argument containing the field/field type
 * properties).
 * </p>
 * <p>
 * The class does not currently offer explicit support for the Schema API
 * operations exposed through Managed Resources, but such operations can be
 * built with little effort manually based on this class within the client
 * applications.
 * </p>
 * <p>
 ...
 * </p>
 *
 * @see <a href="https://lucene.apache.org/solr/guide/schema-api.html">Solr
 *      Schema API</a>
 * @see <a href=
 *      "https://lucene.apache.org/solr/guide/managed-resources.html">Solr
 *      managed resources</a>
 * @since solr 5.3
 */
public class SchemaRequest extends AbstractSchemaRequest<SchemaResponse> {
	...
	/**
	 * Schema API request that can be used to retrieve the version of the schema for
	...
	/**
	 * Schema API request class that lists the field definitions contained in the
	 * schema.
	 */
	...
	public static class Field extends AbstractSchemaRequest<SchemaResponse.FieldResponse> {
		 ...
		 *
		 * @param fieldName the name of the field for which the definition is to be
		 *                  retrieved
		 */
	...
	/**
	 * Schema API request that lists the dynamic field definitions contained in the
	 * schema.
	 */
	...
	/**
	 * Schema API request that lists the dynamic field definition for the specified
	 * field contained in the schema.
	 */
	public static class DynamicField extends AbstractSchemaRequest<SchemaResponse.DynamicFieldResponse> {
		/**
		 * Creates a new instance of the class.
		 *
		 * @param dynamicFieldName the name of the dynamic field for which the
	...
	/**
	 * Schema API request that retrieves the type definitions for the specified
	 * field type contained in the schema.
	 */
	public static class FieldType extends AbstractSchemaRequest<SchemaResponse.FieldTypeResponse> {
		/**
		 * Creates a new instance of the request.
		 *
		 * @param fieldTypeName the name of the field type for which the definition is
		 *                      to be retrieved
		 */
	...
	/**
	 * Schema API request that retrieves the source and destination of each copy
	 * field in the schema.
	 */
	...
	/**
	 * Schema API request that retrieves the field name that is defined as the
	 * uniqueKey for the index of the specified collection.
	 */
	...
	/**
	 * Retrieves the class name of the global similarity defined (if any) in the
	 * schema.
	 */
	...
	/**
	 * Adds a new field definition to the schema. If the field already exists, the
	 * method {@link #process(SolrClient, String)} will fail. Note that the request
	 * will be translated to json, so please use concrete values (e.g. : true, 1)
	 * instead of their string representation (e.g. : "true", "1") for the field
	 * attributes expecting boolean or number values.
	 */
	public static class AddField extends SingleUpdate {
		/**
		 * Creates a new instance of the request.
		 *
		 * @param fieldAttributes field type attributes that can be used to enrich the
		 *                        field definition.
		 * @see <a href=
		 *      "https://lucene.apache.org/solr/guide/defining-fields.html">Defining
		 *      Solr fields</a>
		 */
	...
	/**
	 * Replaces a field's definition. Note that the full definition for a field must
	 * be supplied - this command will not partially modify a field's definition. If
	 * the field does not exist in the schema the method call
	...
	/**
	 * Removes a field definition from the schema. If the field does not exist in
	 * the schema, or if the field is the source or destination of a copy field rule
	 ...
	 *      "https://lucene.apache.org/solr/guide/defining-fields.html">Defining
	 *      Solr fields</a>
	 * @see <a href="https://lucene.apache.org/solr/guide/dynamic-fields.html">Solr
	 *      dynamic fields</a>
	 */
	...
	/**
	 * Replaces a dynamic field rule in the schema of the specified collection. Note
	 * that the full definition for a dynamic field rule must be supplied - this
	 * command will not partially modify a dynamic field rule's definition. If the
	 * dynamic field rule does not exist in the schema the method call
	 * {@link #process(SolrClient, String)} will fail.
	 */
	public static class ReplaceDynamicField extends SingleUpdate {
		 ...
		 * Creates a new instance of the request.
		 *
		 * @param dynamicFieldAttributes field type attributes that can be used to
		 *                               enrich the field definition.
		 * @see <a href=
		 *      "https://lucene.apache.org/solr/guide/defining-fields.html">Defining
		 *      Solr fields</a>
		 * @see <a href="https://lucene.apache.org/solr/guide/dynamic-fields.html">Solr
	...
	/**
	 * Deletes a dynamic field rule from your schema. If the dynamic field rule does
	 * not exist in the schema, or if the schema contains a copy field rule with a
	 * target or destination that matches only this dynamic field rule the method
	 * call {@link #process(SolrClient, String)} will fail.
	 */
	...
	public static class AddFieldType extends SingleUpdate {
		 ...
		 * @see <a href=
		 *      "https://lucene.apache.org/solr/guide/solr-field-types.html">Solr field
		 *      types</a>
		 */
	...
	/**
	 * Replaces a field type in schema belonging to the schema of the specified
	 * collection. Note that the full definition for a field type must be supplied-
	 * this command will not partially modify a field type's definition. If the
	 * field type does not exist in the schema the method call
	 * {@link #process(SolrClient, String)} will fail.
	 */
	...
	/**
	 * Removes a field type from the schema of the specified collection. If the
	 * field type does not exist in the schema, or if any field or dynamic field
	 * rule in the schema uses the field type, the method call
	 * {@link #process(SolrClient, String)} will fail.
	 */
	...
	public static class AddCopyField extends SingleUpdate {
		 ...
		 * @see <a href=
		 *      "https://lucene.apache.org/solr/guide/copying-fields.html">Copying
		 *      fields</a>
		 */
		 ...
		 * @param source   the source field name
		 * @param dest     the collection of the destination field names
		 * @param maxChars the number of characters to be copied from the source to the
		 *                 dest. Specifying 0 as value, means that all the source
		 *                 characters will be copied to the dest.
		 * @see <a href=
		 *      "https://lucene.apache.org/solr/guide/copying-fields.html">Copying
		 *      fields</a>
		 */
	...
	/**
	 * Deletes a copy field rule from the schema of the specified collection. If the
	 * copy field rule does not exist in the schema then the method call
	 * {@link #process(SolrClient, String)} will fail.
	 */
	...
	/**
	 * <p>
	 * The Schema API offers the possibility to perform one or more add requests in
	 * a single command.
	 * </p>
	 * <p>
	 * The API is transactional and all commands in a single
	 * {@link #process(SolrClient, String)} call either succeed or fail together.
	 * </p>
	 */
