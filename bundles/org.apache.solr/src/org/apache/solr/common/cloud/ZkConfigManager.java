...
public class ZkConfigManager {
	...
	private void copyConfigDirFromZk(String fromZkPath, String toZkPath, Set<String> copiedToZkPaths)
			throws IOException {
		try {
	...
	private void copyData(Set<String> copiedToZkPaths, String fromZkFilePath, String toZkFilePath)
	...
	// This method is used by configSetUploadTool and CreateTool to resolve the
	// configset directory.
	...
	public static Path getConfigsetPath(String confDir, String configSetDir) throws IOException {
		...
		throw new IllegalArgumentException(String.format(Locale.ROOT, "Could not find solrconfig.xml at %s, %s or %s",
