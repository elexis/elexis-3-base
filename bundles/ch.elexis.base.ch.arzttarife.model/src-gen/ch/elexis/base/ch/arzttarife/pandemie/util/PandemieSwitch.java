...
public class PandemieSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PandemiePackage.IPANDEMIE_LEISTUNG: {
				IPandemieLeistung iPandemieLeistung = (IPandemieLeistung)theEObject;
				T result = caseIPandemieLeistung(iPandemieLeistung);
				if (result == null) result = caseWithAssignableId(iPandemieLeistung);
				if (result == null) result = caseIBillable(iPandemieLeistung);
				if (result == null) result = caseDeleteable(iPandemieLeistung);
				if (result == null) result = caseICodeElement(iPandemieLeistung);
				if (result == null) result = caseIdentifiable(iPandemieLeistung);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>IPandemie Leistung</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>IPandemie Leistung</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIPandemieLeistung(IPandemieLeistung object) {
		return null;
	}
