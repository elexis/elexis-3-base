 ...
 *
 * When adding a new parameter here, please also add the corresponding one-line
 * test case in the ShardParamsTest class.
 *
 */
public interface ShardParams {
	 ...
	 * (true/false/{@value #REQUIRE_ZK_CONNECTED})
	 */
	 ...
	 * boolean; accepts {@value #REQUIRE_ZK_CONNECTED} as a valid value indicating
	 * <code>false</code>.
	 *
	 * By default, returns <code>false</code> when {@value #SHARDS_TOLERANT} is not
	 * set in <code>params</code>.
	 */
