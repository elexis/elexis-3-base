...
public class TarmedRequirements {
	...
	/**
	 * Get EAN of the Intermediate where the bill shpould be sent. This must be a
	 * Fall-requirement as defined in INTERMEDIATE and must contain the EAN
	 *
	 * @param fall
	 ...
	 * und umgekehrt
	 *
	 * @param KSK die KSK, welche aus exakt einem Buchstaben, exakt 6 Ziffern und
	 *            optional exakt einem Leerzeichen nach dem Buchstaben und einem
	 *            Punkt vor den letzten beiden Ziffern besteht.
