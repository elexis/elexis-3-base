 ...
 * @generated
 */
public class ComplementarySwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ComplementaryPackage.ICOMPLEMENTARY_LEISTUNG: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>IComplementary Leistung</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>IComplementary Leistung</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIComplementaryLeistung(IComplementaryLeistung object) {
		return null;
	}
