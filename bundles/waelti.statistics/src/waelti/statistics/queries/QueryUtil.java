...
public class QueryUtil {
	 ...
	 * between the given firstYear integer and the actual year. Every array contains
	 * in the first column the year as an integer. All other array elements are
	 * filled with integer values of 0.<br>
	 * This is useful if you want to create some time series.
	 *
	 * @param firstYear the first year of this time series.
	 * @param arraySize the array size of each year, inclusive the date.
	...
	/**
	 * Returns a new list with the cohorts given the size given. The array of the
	 * list has to contain all numerical values. The result list will contain
	 * strings in the first element of each array.
	 *
	 * @param intervall the size of the cohorts.
	 * @return a new list.
	 */
	 ...
	 * containing arrays of strings. This is for convenience, since handling strings
	 * from the beginning of the computation can be complicated and clutter the
	 * code.
	 */
