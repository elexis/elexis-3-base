...
public class Sender implements IDataSender {
	 ...
	 * @return ok on success, error if order is null or order doesn't contain any
	 *         items or items are not valid
	 */
	private XChangeElement addOrder(IOrder order) throws XChangeException {
		 ...
		 * eanId="7600000000000" description="ASPIRIN" quantity="1" positionType="1"/>
		 * </order>
		 */
		...
		sb.append("<order" + " xmlns=\"http://estudio.clustertec.ch/schemas/order\""
				...
				+ " clientNrRose=\"" + escapeXmlAttribute(clientNrRose) + "\"" + " user=\"elexis\" password=\"elexis\"" // must
																														// be
																														// present
																														// or
																														// we
