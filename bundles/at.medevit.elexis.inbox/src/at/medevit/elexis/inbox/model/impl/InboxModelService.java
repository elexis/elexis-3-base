...
public class InboxModelService extends AbstractModelService
	...
	public Optional<Identifiable> loadFromString(String storeToString){
		...
		if (storeToString.startsWith("at.medevit.elexis.inbox.model")) {
	...
	public <T> IQuery<T> getQuery(Class<T> clazz, boolean refreshCache, boolean includeDeleted){
		return new InboxQuery<>(clazz, refreshCache,
