...
public class DeviceView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		TableViewerColumn tableViewerColumnTestkrzel = new TableViewerColumn(tableViewerCMM, SWT.NONE);
		...
		TableViewerColumn tableViewerColumnRefLaboritem = new TableViewerColumn(tableViewerCMM, SWT.NONE);
		...
		TableViewerColumn tableViewerColumnNoKommastellen = new TableViewerColumn(tableViewerCMM, SWT.NONE);
		TableColumn tblclmnNoKommastellen = tableViewerColumnNoKommastellen.getColumn();
		tblclmnNoKommastellen.setToolTipText(Messages.DeviceView_tblclmnNoKommastellen_toolTipText);
		tblclmnNoKommastellen.setWidth(70);
		tblclmnNoKommastellen.setText(Messages.DeviceView_tblclmnNoKommastellen_text);

		TableViewerColumn tableViewerColumnReferenzM = new TableViewerColumn(tableViewerCMM, SWT.NONE);
		...
		TableViewerColumn tableViewerColumnReferenzW = new TableViewerColumn(tableViewerCMM, SWT.NONE);
		...
		compositeButtonContainer.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false, 1, 1));
