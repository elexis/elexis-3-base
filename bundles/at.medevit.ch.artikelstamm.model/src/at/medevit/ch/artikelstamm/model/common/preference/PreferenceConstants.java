...
public class PreferenceConstants {
	...
	private static final String PREF_COMMON_BASE = "artikelstamm/"; //$NON-NLS-1$
	public static final String PREV_CSV_MARGE_STORAGE = PREF_COMMON_BASE + "csvMargeStorage"; //$NON-NLS-1$
	public static final String PREF_ATC_CODE_LANGUAGE = PREF_COMMON_BASE + "atcCodeLanguage"; //$NON-NLS-1$
