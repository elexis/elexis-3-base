...
/**
 * A collection of params used in DisMaxRequestHandler, both for Plugin
 * initialization and for Requests.
 */
public interface DisMaxParams {
	...
	/**
	 * If set to true, will try to reduce MM if tokens are removed from some clauses
	 * but not all
	 */
	public static String MM_AUTORELAX = "mm.autoRelax";

	/**
	 * query and init param for Phrase Slop value in phrase boost query (in pf
	 * fields)
	 */
	...
	/**
	 * query and init param for phrase Slop value in phrases explicitly included in
	 * the user's query string ( in qf fields)
	 */
	...
	/**
	 * Alternate query (expressed in Solr QuerySyntax) to use if main query (q) is
	 * empty
	 */
