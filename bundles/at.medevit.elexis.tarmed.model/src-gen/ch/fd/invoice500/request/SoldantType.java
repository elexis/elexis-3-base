 ...
 *       &lt;/sequence&gt;
 *       &lt;attribute name="allowTS" use="required" type="{http://www.w3.org/2001/XMLSchema}boolean" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class SoldantType {
    ...
    @XmlAttribute(name = "allowTS", required = true)
    protected boolean allowTS;
    ...
    /**
     * Ruft den Wert der allowTS-Eigenschaft ab.
     * 
     */
    public boolean isAllowTS() {
        return allowTS;
    }

    /**
     * Legt den Wert der allowTS-Eigenschaft fest.
     * 
     */
    public void setAllowTS(boolean value) {
        this.allowTS = value;
    }
