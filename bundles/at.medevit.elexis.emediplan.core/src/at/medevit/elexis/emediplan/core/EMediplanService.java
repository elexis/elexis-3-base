...
public interface EMediplanService {
	 ...
	 * @param output
	 */
	public default void exportEMediplanPdf(IMandator author, IPatient patient, List<IPrescription> prescriptions,
			OutputStream output) {
	...
	public default void exportEMediplanPdf(IMandator author, IPatient patient, List<IPrescription> prescriptions,
		...
		exportEMediplanPdf(author, patient, prescriptions, addDesc, null, output);
	}
	 ...
	 * @param prescriptions
	 * @param addDesc
	 * @param remark        remark of the author on this plan, printed in the
	 *                      comment block and included in the 2D barcode, may be
	 *                      <code>null</code>
	 * @param output
	 */
	 ...
	 * @param output
	 */
	public default void exportEMediplanJson(IMandator author, IPatient patient, List<IPrescription> prescriptions,
			OutputStream output) {
	...
	/**
	 * Get a CHMED eMediplan (http://emediplan.ch/de/home) representation of the
	 * prescriptions of the patient, written to the provided {@link OutputStream}.
	 * If addDesc is true a desc private field is added to all medication entries of
	 * the JSON emediplan.
	 *
	...
	/**
	 * Search for {@link ArtikelstammItem} by EAN or PharamaCode and creates for
	 * each {@link Posology} a new {@link Medication} entry with a single
	 * {@link Posology}
	 *
	 * @param medication
	 * @return
