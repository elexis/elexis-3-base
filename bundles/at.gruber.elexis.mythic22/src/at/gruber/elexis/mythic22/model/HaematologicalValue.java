...
/**
 * This class represents one haematological value
 * These values are delivered from mythic22
 * @author Christian
 *
 */
public class HaematologicalValue {
	...
	public HaematologicalValue(String identifier, String value, String flagA,
			String flagB, String lowPanicValue, String lowNormalValue,
			String highNormalValue, String highPanicValue) {
		super();
	...
	public HaematologicalValue(String identifier, String csvValues) {
		...
		// else: field is empty because no values have been sent from mythic22 -> Attributes are an empty String ""
		}
	}
