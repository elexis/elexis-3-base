...
public class OleWordApplication extends OleWrapper {
	...
	public OleWordApplication(OleWordSite site, OleAutomation oleAuto, Display display,
	...
	/**
	 * Get points for millimeters. Tried to call MillimetersToPoints method here but could not due
	 * to missing Single data type.
	 * 
	 * @param millimeters
	 * @return
	 */
