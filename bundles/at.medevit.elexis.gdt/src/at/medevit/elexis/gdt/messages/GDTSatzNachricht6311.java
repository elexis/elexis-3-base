...
public class GDTSatzNachricht6311 extends GDTSatzNachricht {
	...
	/**
	 * Erstellt eine GDT Satzart Nachricht vom Typ "Daten einer Untersuchung zeigen"
	 * 6311
	 *
	 ...
	 * @param gdtVersion
	 */
	public GDTSatzNachricht6311(String patientenkennung, String namenszusatz, String nachnamePatient,
			String vornamePatient, String geburtsdatumPatient, String titelPatient, String tagErhebungBehandlungsdaten,
			String uhrzeitErhebungBehandlungsdaten, String guvskf, String abnahmeDatum, String abnahmeZeit,
			String gdtIdReceiver, String gdtIdSender, String zeichensatz, String gdtVersion) {
		super(GDTConstants.SATZART_DATEN_EINER_UNTERSUCHUNG_ZEIGEN, gdtIdReceiver, gdtIdSender, zeichensatz,
				gdtVersion);
	...
	/**
	 * Bequemlichkeits Konstruktor für Datensatz 6311 - Beinhaltet nur die MUSS
	 * Felder
	 *
	 * @param patientenkennung
	 *
	...
	public GDTSatzNachricht6311(String patientenkennung, String gdtVersion) {
		this(patientenkennung, null, null, null, null, null, null, null, null, null, null, null, null, null,
				gdtVersion);
	}
	...
	public static GDTSatzNachricht6311 createfromStringArray(String[] satznachricht) {
		...
		if (satzkennung != GDTConstants.SATZART_DATEN_EINER_UNTERSUCHUNG_ZEIGEN)
			return null;

		return new GDTSatzNachricht6311(ds.get(GDTConstants.FELDKENNUNG_PATIENT_KENNUNG),
				ds.get(GDTConstants.FELDKENNUNG_PATIENT_NAMENSZUSATZ), ds.get(GDTConstants.FELDKENNUNG_PATIENT_NAME),
				ds.get(GDTConstants.FELDKENNUNG_PATIENT_VORNAME), ds.get(GDTConstants.FELDKENNUNG_PATIENT_GEBURTSDATUM),
				...
				ds.get(GDTConstants.FELDKENNUNG_ABNAHME_DATUM), ds.get(GDTConstants.FELDKENNUNG_ABNAHME_ZEIT),
