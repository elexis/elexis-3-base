...
public final class XMLErrorLogger implements ErrorHandler, ErrorListener, XMLReporter {
	...
	public void warning(SAXParseException e) {
		log.warn("XML parse warning in '{}', line {}, column {}:", e.getSystemId(), e.getLineNumber(),
				e.getColumnNumber(), e);
	}
	...
	public void report(String message, String errorType, Object relatedInformation, Location loc) {
		...
		if (loc != null) {
			sb.append(" in \"").append(loc.getSystemId()).append("\", line ").append(loc.getLineNumber())
					.append(", column ").append(loc.getColumnNumber());
		}
