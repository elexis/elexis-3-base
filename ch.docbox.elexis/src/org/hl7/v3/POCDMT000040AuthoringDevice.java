...
@XmlType(name = "POCD_MT000040.AuthoringDevice", propOrder = {
	"realmCode", "typeId", "templateId", "code", "manufacturerModelName", "softwareName",
	"asMaintainedEntity"
})
public class POCDMT000040AuthoringDevice {
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any
	 * modification you make to the returned list will be present inside the JAXB object. This is
	 * why there is not a <CODE>set</CODE> method for the asMaintainedEntity property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link EntityClassDevice }
	 * 
	 */
