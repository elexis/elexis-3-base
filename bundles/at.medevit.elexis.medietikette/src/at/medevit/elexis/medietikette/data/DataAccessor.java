...
public class DataAccessor implements IDataAccess {
	...
	private Element[] elements = { new Element(IDataAccess.TYPE.STRING, "Name", //$NON-NLS-1$
			"[Medietikette:-:-:Name]", null, 0), //$NON-NLS-1$
			new Element(IDataAccess.TYPE.STRING, "Preis", //$NON-NLS-1$
					"[Medietikette:-:-:Preis]", null, 0), //$NON-NLS-1$
			new Element(IDataAccess.TYPE.STRING, "OPGroesse", //$NON-NLS-1$
					"[Medietikette:-:-:OPGroesse]", null, 0), //$NON-NLS-1$
			new Element(IDataAccess.TYPE.STRING, "Dosis", //$NON-NLS-1$
					"[Medietikette:-:-:Dosis]", null, 0), //$NON-NLS-1$
			new Element(IDataAccess.TYPE.STRING, "EAN", //$NON-NLS-1$
					"[Medietikette:-:-:EAN]", null, 0), //$NON-NLS-1$
			new Element(IDataAccess.TYPE.STRING, "Pharmacode", //$NON-NLS-1$
