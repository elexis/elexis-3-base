 ...
 *
 * @param Value is a string which will be displayed to describe the input which
 *              is expected.
 * @param Index is a integer which defines the order in which the fields are
 *              displayed.
 */
...
public @interface GetProperty {
	...
	/**
	 * Field description. There has to be a setter method annotated with a
