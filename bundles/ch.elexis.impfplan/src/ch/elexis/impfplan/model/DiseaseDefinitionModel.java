...
/**
 * @deprecated Copied from at.medevit.elexis.impfplan to avoid dependency
 * @author Lucia
 *
 */
public class DiseaseDefinitionModel {
	...
	private static void initDiseases() {
		...
		diseases.add(new DiseaseDefinition("J07BE", "Mumps")); //$NON-NLS-1$ //$NON-NLS-2$
		...
		diseases.add(new DiseaseDefinition("J07BM", "humanes PapillomaVirus")); //$NON-NLS-1$ //$NON-NLS-2$
		diseases.add(new DiseaseDefinition("J07BB", "Influenza")); //$NON-NLS-1$ //$NON-NLS-2$
		...
		diseases.add(new DiseaseDefinition("J07BK", "Varizellen", "Varicella zoster")); //$NON-NLS-1$ //$NON-NLS-3$
		...
		diseases.add(new DiseaseDefinition("J07BK01", "Windpocken - Varizellen")); //$NON-NLS-1$ //$NON-NLS-2$
