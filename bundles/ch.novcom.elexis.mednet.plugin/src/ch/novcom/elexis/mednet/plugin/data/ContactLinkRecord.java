...
/**
 * This object represents a ContactLinkRecord from the database This manage the
...
public class ContactLinkRecord extends PersistentObject implements Comparable<ContactLinkRecord> {
	...
	// LoggerFactory.getLogger(ContactLinkRecord.class.getName());
...
//			"CREATE UNIQUE INDEX " + ContactLinkRecord.TABLENAME + "_idx_Path on " + ContactLinkRecord.TABLENAME + "(" + ContactLinkRecord.FLD_PATH +");";
	...
	private static final String createTable = "CREATE TABLE " + ContactLinkRecord.TABLENAME + "("
			+ PersistentObject.FLD_ID + " VARCHAR(25) primary key," + ContactLinkRecord.FLD_CONTACT_ID + " VARCHAR(25),"
			+ ContactLinkRecord.FLD_MEDNET_ID + " VARCHAR(255)," + ContactLinkRecord.FLD_CATEGORY_DOC + " VARCHAR(255),"
			+ ContactLinkRecord.FLD_CATEGORY_FORM + " VARCHAR(255)," + ContactLinkRecord.FLD_DOCIMPORT_ISACTIVE
			+ " CHAR(1) default '1'," + ContactLinkRecord.FLD_DOCIMPORT_ID + " VARCHAR(255),"
			+ ContactLinkRecord.FLD_FORMIMPORT_ISACTIVE + " CHAR(1) default '1'," + ContactLinkRecord.FLD_XID_DOMAIN
			+ " VARCHAR(255)," + PersistentObject.FLD_LASTUPDATE + " BIGINT," + PersistentObject.FLD_DELETED
			+ " CHAR(1) default '0'" + ");";

	private static final String addMedNetIndex = "CREATE INDEX " + ContactLinkRecord.TABLENAME + "_idx_mednet on "
			+ ContactLinkRecord.TABLENAME + "(" + ContactLinkRecord.FLD_MEDNET_ID + ");";

	private static final String addImportIsActiveColumns = "ALTER TABLE " + ContactLinkRecord.TABLENAME + " ADD "
			+ ContactLinkRecord.FLD_DOCIMPORT_ISACTIVE + " CHAR(1) default '1'," + " ADD "
			+ ContactLinkRecord.FLD_FORMIMPORT_ISACTIVE + " CHAR(1) default '1';";

	private static final String addDocImportIdColumns = "ALTER TABLE " + ContactLinkRecord.TABLENAME + " ADD "
	...
	static {
		addMapping(ContactLinkRecord.TABLENAME, ContactLinkRecord.FLD_CONTACT_ID, ContactLinkRecord.FLD_MEDNET_ID,
	...
	public ContactLinkRecord(String contactID, String mednetID, String category_doc, String category_form,
			boolean docImport_isActive, String docImport_id, boolean formImport_isActive, String xidDomain) {

		create(null);
		set(new String[] { FLD_CONTACT_ID, FLD_MEDNET_ID, FLD_CATEGORY_DOC, FLD_CATEGORY_FORM, FLD_DOCIMPORT_ISACTIVE,
				FLD_DOCIMPORT_ID, FLD_FORMIMPORT_ISACTIVE, FLD_XID_DOMAIN }, contactID, mednetID, category_doc,
				category_form, docImport_isActive ? "1" : "0", docImport_id, formImport_isActive ? "1" : "0",
				xidDomain);
	...
	public boolean docImport_isActive() {
		return PersistentObject.checkNull(this.get(ContactLinkRecord.FLD_DOCIMPORT_ISACTIVE)).equals("1") ? true
				: false;
	}
	...
	public boolean formImport_isActive() {
		return PersistentObject.checkNull(this.get(ContactLinkRecord.FLD_FORMIMPORT_ISACTIVE)).equals("1") ? true
				: false;
	}
	...
	public String getLabel() {
		String[] fields = { ContactLinkRecord.FLD_CONTACT_ID, ContactLinkRecord.FLD_MEDNET_ID,
				ContactLinkRecord.FLD_CATEGORY_DOC, ContactLinkRecord.FLD_CATEGORY_FORM,
				ContactLinkRecord.FLD_DOCIMPORT_ISACTIVE, ContactLinkRecord.FLD_DOCIMPORT_ID,
				ContactLinkRecord.FLD_FORMIMPORT_ISACTIVE, ContactLinkRecord.FLD_XID_DOMAIN };
		...
		return MessageFormat.format(MedNetMessages.ContactLinkRecord_Label, vals[0], vals[1], vals[2], vals[3], vals[4],
	...
	/**
	 * Get a List of ContactLinkRecord matching the specified parameters in the
	 * database By specifying null parameters the ContactLinkRecord selection can be
	 * broadened.
	 *
	 * @param contactId
	 * @param mednetId
