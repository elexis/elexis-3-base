...
/**
 * Hold values of terms, this class is immutable. Create a new instance for
 * every mutation
 */
public class ShardTerms implements MapWriter {
	...
	public ShardTerms(Map<String, Long> values, int version) {
		...
		if (values.isEmpty())
			...
			this.maxTerm = Collections.max(values.values());
	}
	...
	/**
	 * Return a new {@link ShardTerms} in which term of {@code leader} is higher
	 * than {@code replicasNeedingRecovery}
	 *
	 * @param leader                  coreNodeName of leader
	 * @param replicasNeedingRecovery set of replicas in which their terms should be
	 *                                lower than leader's term
	 * @return null if term of {@code leader} is already higher than
	 *         {@code replicasNeedingRecovery}
	 */
	...
	/**
	 * Return a new {@link ShardTerms} in which terms for the {@code coreNodeName}
	 * are removed
	 *
	 * @param coreNodeName of the replica
	...
	/**
	 * Return a new {@link ShardTerms} in which the associate term of
	 * {@code coreNodeName} is equal to zero, creating it if it does not previously
	 * exist.
	 *
	 * @param coreNodeName of the replica
	...
	/**
	 * Return a new {@link ShardTerms} in which the term of {@code coreNodeName} is
	 * max
	 *
	 * @param coreNodeName of the replica
	 ...
	 *
	 * @param coreNodeName of the replica
	 * @return null if term of {@code coreNodeName} is already finished doing
	 *         recovering
	 */
