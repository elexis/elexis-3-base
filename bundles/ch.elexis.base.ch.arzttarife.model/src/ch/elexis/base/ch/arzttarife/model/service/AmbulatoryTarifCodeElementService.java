...
@Component
public class AmbulatoryTarifCodeElementService implements ICodeElementServiceContribution, IStoreToStringContribution {
	...
	public Optional<ICodeElement> loadFromCode(String code, Map<Object, Object> context) {
		...
		gtinQuery.setParameter("typ", AmbulantePauschalenTyp.TRIGGER.getCode());
