...
FC.HitDragListener = HitDragListener;
...
var Grid = FC.Grid = Class.extend(ListenerMixin, {
	...
	fabricateHelperEvent: function(eventLocation, sourceSeg) {
		...
		if (!(eventLocation.resource === undefined)) {
			fakeEvent.resource = eventLocation.resource;
		}
	...
	buildSegDragListener: function(seg) {
		...
		var dragListener = this.segDragListener = new HitDragListener(view, {
			...
			hitOver: function(hit, isOrig, origHit) {
				...
				if (!(_this.resourceIds === undefined) && !(hit.col === undefined) ) {
					dropLocation.resource = _this.resourceIds[hit.col];
				}
