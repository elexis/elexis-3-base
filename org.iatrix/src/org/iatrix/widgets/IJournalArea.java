...
/**
 * A small helper class. Areas may add code to properly update their part.
 * The following callbacks are present
 * activation
 * visible
 * changed patient
...
public interface IJournalArea {
	...
	/**
	 *
	 * @param mode indicates whether view should be become visible
	 */
	public void visible(boolean mode);

	/**
	 *
	 * @param mode. True on startup, false on teardown
	 */
	public void activation(boolean mode);

	/**
	 *
	 * @param newPatient to set may be null
	 */
	 ...
	 *
	 * @param newKons Neue Konsultation kann leer sein
	 * @param putCaretToEnd
	 *            if true, activate text field ant put caret to the end
	 */
	/**
	 *
	 * @param newKons to set may be null
	 */
