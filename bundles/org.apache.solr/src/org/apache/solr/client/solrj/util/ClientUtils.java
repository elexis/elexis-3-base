...
public class ClientUtils {
	...
	private static void writeVal(Writer writer, String name, Object v, String update) throws IOException {
		if (v instanceof Date) {
			...
			v = Base64.byteArrayToBase64(bytes.array(), bytes.arrayOffset() + bytes.position(),
	...
	/**
	 * Constructs a slices map from a collection of slices and handles
	 * disambiguation if multiple collections are being queried simultaneously
	 */
