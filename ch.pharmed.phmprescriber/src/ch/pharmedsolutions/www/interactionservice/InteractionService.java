    ...
    extends Service
{
    ...
    private final static QName INTERACTIONSERVICE_QNAME = new QName("https://www.pharmedsolutions.ch/InteractionService", "InteractionService");
     ...
     * 
     * @return
     *     returns InteractionPortType
     */
    @WebEndpoint(name = "InteractionPort")
    public InteractionPortType getInteractionPort() {
        return super.getPort(new QName("https://www.pharmedsolutions.ch/InteractionService", "InteractionPort"), InteractionPortType.class);
    }
    ...
    public InteractionPortType getInteractionPort(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.pharmedsolutions.ch/InteractionService", "InteractionPort"), InteractionPortType.class, features);
    }
