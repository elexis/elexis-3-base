 ...
 * occurred during updates. This class is only useful when the
 * <code>TolerantUpdateProcessorFactory</code> is used in an update processor
 * chain
 */
public final class ToleratedUpdateError {
	...
	/**
	 * Given a 'maxErrors' value such
	 * that<code>-1 &lt;= maxErrors &lt;= {@link Integer#MAX_VALUE}</code> this
	 * method returns the original input unless it is <code>-1</code> in which case
	 * the effective value of {@link Integer#MAX_VALUE} is returned. Input of
	 * <code>maxErrors &lt; -1</code> will trip an assertion and otherwise have
	 * undefined behavior.
	 *
	 ...
	 * Given a 'maxErrors' value such
	 * that<code>-1 &lt;= maxErrors &lt;= {@link Integer#MAX_VALUE}</code> this
	 * method returns the original input unless it is {@link Integer#MAX_VALUE} in
	 * which case <code>-1</code> is returned for user convinience. Input of
	 * <code>maxErrors &lt; -1</code> will trip an assertion and otherwise have
	 * undefined behavior.
	 *
	...
	/**
	 * returns a ToleratedUpdateError instance if this metadataKey is one we care
	 * about, else null
	 *
	 * @see #getMetadataKey
	 ...
	 * {@link SolrException#setMetadata}
	 *
	...
	public boolean equals(Object o) {
		if (o instanceof ToleratedUpdateError) {
			...
			return that.type.equals(this.type) && that.id.equals(this.id) && that.message.equals(this.message);
		}
		return false;
	}
	...
	public static enum CmdType {
		...
		// needs to be smarter to account for 'id' being null ... "usesId" should be a
		// prop of enum instances
	}
}
