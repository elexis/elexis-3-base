...
public class TermineDruckenDialog extends TitleAreaDialog implements ICallback {
	...
	protected Control createDialogArea(Composite parent){
		...
		text.createFromTemplateName(null, TT_APPOINTMENT_CARD, Brief.UNKNOWN, CoreHub.getActContact(),
			"Agenda");
		/*
	...
	public boolean doPrint(){
		...
		String printer =
			CoreHub.localCfg.get(PreferenceConstants.AG_PRINT_APPOINTMENTCARD_PRINTER_NAME, "");
		String tray =
			CoreHub.localCfg.get(PreferenceConstants.AG_PRINT_APPOINTMENTCARD_PRINTER_TRAY, null);
