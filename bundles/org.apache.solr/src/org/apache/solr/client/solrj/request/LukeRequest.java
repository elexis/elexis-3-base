...
public class LukeRequest extends SolrRequest<LukeResponse> {
	...
	/**
	 * the number of terms to return for a given field. If the number is 0, it will
	 * not traverse the terms.
	 */
	 ...
	 *
	 * Fetching and returning the index-flags for each field in your index has
	 * non-zero cost, and can slow down requests to /luke. Users who do not care
	 * about these values can tell Solr to avoid generating them by setting the
	 * 'includeIndexFieldFlags' flag to false, saving their requests some
	 * processing.
	 */
