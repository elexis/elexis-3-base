...
public class ElexisTextPlugin implements ITextPlugin {
	...
	public boolean insertTable(final String place, final int properties, final String[][] contents,
		...
		editor.insertTable(matcher.start(), matcher.end(), contents, (properties & FIRST_ROW_IS_HEADER) != 0,
				(properties & GRID_VISIBLE) != 0, font, (int) size, style);
	...
	private Pos findOrReplace(final Pattern pattern, final StyledText styledText, final ReplaceCallback callback,
