...
public interface VacdocService {
	...
	/**
	 * Get empty {@link CdaChVacd} document with patient as Patient and mandant as Author. Also the
	 * fields Custodian and LegalAuthenticator are initialized.
	 * 
	 * @param patient
	 * @param mandant
	...
	/**
	 * Add all {@link Vaccination} instances, of the {@link Patient} referenced in the provided
	 * {@link CdaChVacd}, to the provided {@link CdaChVacd}.
	 * 
	 * @param doc
	 */
	...
	/**
	 * Add the provided {@link Vaccination} instances to the provided {@link CdaChVacd}.
	 * 
	 * @param doc
	 */
