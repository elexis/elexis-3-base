...
public class Tarmed50Validator {
	...
	private Validator initValidator() throws SAXException {
		...
		factory.setResourceResolver(new LSResourceResolver() {
			...
			public LSInput resolveResource(String type, String namespaceURI, String publicId, String systemId,
					String baseURI) {
				LoggerFactory.getLogger(Tarmed50Validator.class).info(
				...
				InputStream is = Tarmed50Validator.class.getResourceAsStream("/rsc/" + systemId);
				if (is == null) {
					LoggerFactory.getLogger(Tarmed50Validator.class)
		...
		LoggerFactory.getLogger(Tarmed50Validator.class)
				.warn("Loading generalInvoiceRequest_500.xsd using factory [" + factory + "]");
		factory.setFeature("http://apache.org/xml/features/honour-all-schemaLocations", false);
		Schema schema = factory.newSchema(
				new StreamSource(Tarmed50Validator.class.getResourceAsStream("/rsc/generalInvoiceRequest_500.xsd")));
