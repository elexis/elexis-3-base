 ...
 * cluster property really should be treated like a static global that is set at
 * initialization and not altered after.
 *
 * Client applications should not use this class directly; it is only included
 * in SolrJ because Replica and ZkNodeProps depend on it.
 */
public enum UrlScheme {
	...
	/**
	 * Set the global urlScheme variable; ideally this should be immutable once set,
	 * but some tests rely on changing the value on-the-fly.
	 *
	...
	/**
	 * Given a URL string with or without a scheme, return a new URL with the
	 * correct scheme applied.
	 *
	...
	public String applyUrlScheme(final String url) {
		...
		// heal an incorrect scheme if needed, otherwise return null indicating no
		// change
