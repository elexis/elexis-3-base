...
public class OutputView extends ViewPart {
	...
	/**
	 * Header block containing all information displayed at the head of the output.
	 * E.g. creating date, queries name.
	 */
	...
	/**
	 * Sets the header to be displayed for the result composite. E.g. contains
