...
/**
 * Create Objects of this class to do dispose on all created OleWrapper objects.
 * OleWrapper will add it self in constructor. If OleWrapper is a return value,
 * remove it to prevent disposal.
 *
 * @author thomashu
 *
 */
