...
public class CstProimmun extends PersistentObject {
	...
	final static String create = "CREATE TABLE " + TABLENAME + " (" + "	`ID` VARCHAR(25) NOT NULL,	"
			...
			+ "`datum` CHAR(8) NULL DEFAULT NULL,	" + "`ProfileID` VARCHAR(25) NULL DEFAULT NULL,	"
			+ "`Text1` TEXT NULL,	" + "`Text2` TEXT NULL,	" + "`Text3` TEXT NULL,	" + "`Text4` TEXT NULL,	"
			+ "`Tested` SMALLINT(6) NULL DEFAULT '0',	" + "`ToBeTested` SMALLINT(6) NULL DEFAULT '0',	"
	...
	static {
		addMapping(TABLENAME, "profileId=ProfileId", "datum=Datum", "text1=Text1", "text2=Text2", "text3=Text3",
				"text4=Text4", "tested=Tested", "toBeTested=ToBeTested");
	...
	public CstProimmun(String profileId, String datum) {
		...
		if (existing != null) {
			throw new IllegalArgumentException(
					String.format("Mapping for origin id [%s] - already exists can not create multiple instances.", //$NON-NLS-1$
							profileId));
		}
