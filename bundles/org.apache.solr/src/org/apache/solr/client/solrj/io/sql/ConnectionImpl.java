...
class ConnectionImpl implements Connection {
	...
	/*
	 * When using OpenLink ODBC-JDBC bridge on Windows, it runs the method
	 * ConnectionImpl.setReadOnly(String ...). The spec says that
	 * setReadOnly(boolean ...) is required. This causes the ODBC-JDBC bridge to
	 * fail on Windows. OpenLink case:
	 * http://support.openlinksw.com/support/techupdate.vsp?c=21881
	 */
	...
	public void setTransactionIsolation(int level) throws SQLException {
		...
		if (Connection.TRANSACTION_READ_COMMITTED == level || Connection.TRANSACTION_READ_UNCOMMITTED == level
