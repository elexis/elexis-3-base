...
public class ImageCombo extends Composite {
	 ...
	 * </p>
	 *
	 * @param parent                a composite control which will be the parent of
	 *                              the new instance (cannot be null)
	 * @param style                 the style of control to construct
	 * @param collapsedIconPosition the position of the icon in collapsed state
	 *                              (SWT.LEFT (default) or SWT.RIGHT)
	 ...
	 * <p>
	 * <code>widgetSelected</code> is called when the user changes the combo's list
	 * selection. <code>widgetDefaultSelected</code> is typically called when ENTER
