...
public class PreferencePage extends org.eclipse.jface.preference.PreferencePage implements IWorkbenchPreferencePage {
	...
	private void createOutputConfig(TabItem item) {
		...
		pathGroup.addPathEditor(OutputterUtil.CFG_PRINT_GLOBALXMLDIR, "XML Verzeichnis").setFixedScheme("file");
		pathGroup.addPathEditor(OutputterUtil.CFG_PRINT_GLOBALPDFDIR, "PDF Verzeichnis").setFixedScheme("file");
