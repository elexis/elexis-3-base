    ...
    <html>
      <head>
        ...
        <style type="text/css" media="screen">
          <xsl:comment> body { color: #003366; font-size: 12px; line-height: normal; font-family: Verdana, Arial, sans-serif;
            ...
            table { line-height: 10pt; border-width: 0; border-color: #eeeeee } </xsl:comment>
        </style>
      </head>
      ...
      <body>
        <table width="100%" cellspacing="1" cellpadding="5">
          ...
          <tr bgcolor="#ccccff">
            <td width="10%" valign="top">
              <xsl:text>Behandelnder Arzt:</xsl:text>
            </td>
        ...
        <table width="100%" cellspacing="1" cellpadding="5">
          ...
          <xsl:for-each select="/n1:ClinicalDocument/n1:author">
            <tr>
              <td width="20%" bgcolor="#3399ff">
                <b>Mitbehandelnde Heilberufler:</b>
              </td>
              <td width="80%" bgcolor="#ccccff">
    ...
    <table width="100%" cellspacing="1" cellpadding="5">
      ...
      <xsl:for-each select="/n1:ClinicalDocument/n1:authenticator">
        <tr>
          <td width="20%" bgcolor="#3399ff">
            <b>
              <xsl:text>Authenifiziert: </xsl:text>
            </b>
          </td>
          <td width="80%" bgcolor="#ccccff">
            <xsl:call-template name="getName">
