...
public class Preferences extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	protected void createFieldEditors() {
		...
		addField(
				new StringFieldEditor(PreferenceConstants.cfgTemplateBill, "Vorlage ohne ESR", getFieldEditorParent()));
		addField(new KontaktFieldEditor(new ConfigServicePreferenceStore(Scope.GLOBAL), PreferenceConstants.cfgBank,
				"Bank", getFieldEditorParent()));
		addField(
				new StringFieldEditor(PreferenceConstants.esrIdentity, "ESR-Teilnehmernummer", getFieldEditorParent()));
