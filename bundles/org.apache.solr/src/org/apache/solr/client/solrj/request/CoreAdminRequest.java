...
public class CoreAdminRequest extends SolrRequest<CoreAdminResponse> {
	 ...
	 *
	 * @throws IllegalArgumentException if the new core name contains invalid
	 *                                  characters.
	 */
	...
	public static CoreAdminResponse createCore(String name, String instanceDir, SolrClient client, String configFile,
			String schemaFile) throws SolrServerException, IOException {
		return createCore(name, instanceDir, client, configFile, schemaFile, null, null);
	}

	public static CoreAdminResponse createCore(String name, String instanceDir, SolrClient client, String configFile,
			String schemaFile, String dataDir, String tlogDir) throws SolrServerException, IOException {
