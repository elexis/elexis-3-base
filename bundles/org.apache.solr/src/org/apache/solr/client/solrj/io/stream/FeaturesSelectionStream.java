...
public class FeaturesSelectionStream extends TupleStream implements Expressible {
	...
	public FeaturesSelectionStream(String zkHost, String collectionName, @SuppressWarnings({ "rawtypes" }) Map params,
			String field, String outcome, String featureSet, int positiveLabel, int numTerms) throws IOException {
	...
	private void init(String collectionName, String zkHost, @SuppressWarnings({ "rawtypes" }) Map params, String field,
			String outcome, String featureSet, int positiveLabel, int numTopTerms) throws IOException {
		this.zkHost = zkHost;
	...
	public void open() throws IOException {
		...
		this.executorService = ExecutorUtil
				.newMDCAwareCachedThreadPool(new SolrNamedThreadFactory("FeaturesSelectionStream"));
	}
	...
	public Tuple read() throws IOException {
		try {
			if (tupleIterator == null) {
				...
				Future<NamedList> getTopTermsCall : callShards(getShardUrls())) {
					@SuppressWarnings({ "rawtypes" })
