 ...
 * {@link org.apache.solr.client.solrj.request.DocumentAnalysisRequest}. Holds a
 * map of {@link DocumentAnalysis} objects by a document id (unique key).
 *
 *
 * @since solr 1.4
 */
public class DocumentAnalysisResponse extends AnalysisResponseBase
	...
	public void setResponse(NamedList<Object> response) {
		...
		NamedList<NamedList<NamedList<Object>>> analysis = (NamedList<NamedList<NamedList<Object>>>) response
				.get("analysis");
	...
	/**
	 * Returns the document analysis for the document associated with the given
	 * unique key (id), {@code null} if no such association exists.
	 *
	 * @param documentKey The document unique key.
	 *
	 * @return The document analysis for the document associated with the given
	 *         unique key (id).
	 */
	...
	/**
	 * An analysis process breakdown of a document. Holds a map of field analyses by
	 * the field name.
	 */
	...
	/**
	 * An analysis process breakdown for a specific field. Holds a list of query
	 * time analysis phases (that is, if a query analysis was requested in the first
	 * place) and a list of index time analysis phases for each field value (a field
	 * can be multi-valued).
	 */
	public static class FieldAnalysis {
		...
		/**
		 * Returns the number of query time analysis phases or {@code -1} if this field
		 * analysis doesn't hold a query time analysis.
		 *
		 * @return Returns the number of query time analysis phases or {@code -1} if
		...
		/**
		 * Returns the query time analysis phases for the field or {@code null} if this
		 * field doesn't hold a query time analysis.
		 *
		 * @return Returns the query time analysis phases for the field or {@code null}
