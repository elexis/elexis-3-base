...
public class HeatmapFacetMap extends JsonFacetMap<HeatmapFacetMap> {
	...
	@Override
	public HeatmapFacetMap withSubFacet(String facetName, @SuppressWarnings({ "rawtypes" }) JsonFacetMap map) {
	 ...
	 *
	 * If not set, defaults to being computed by {@code distErrPct} or
	 * {@code distErr}
	 *
	 ...
	 *
	 * Used to compute the size of each cell in the heatmap grid rather than
	 * specifying {@link #setGridLevel(int)}
	 *
	 * @param distErr a positive value representing the maximum acceptable cell
	 *                error.
	 *
	 * @see #setGridLevel(int)
	 * @see #setDistErrPct(double)
