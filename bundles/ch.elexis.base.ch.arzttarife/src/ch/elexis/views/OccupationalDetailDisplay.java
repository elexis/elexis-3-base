...
public class OccupationalDetailDisplay implements IDetailDisplay {
	...
	public void selection(
			@Optional @Named("ch.elexis.views.codeselector.occupational.selection") IOccupationalLeistung occupational) {
		if (occupational != null && !form.isDisposed()) {
	...
	public void display(Object obj) {
		IOccupationalLeistung ll = (IOccupationalLeistung) obj;
