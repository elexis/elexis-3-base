...
public class ModifiableSolrParams extends SolrParams {
	...
	/**
	 * If the input params are of type MofifiableSolrParams, returns the input,
	 * otherwise, constructs a new ModifiableSolrParams, copying values from the
	 * given params. If params is null, returns an empty ModifiableSolrParams
	 * instance.
	 */
	...
	/**
	 * Replace any existing parameter with the given name. if val==null remove key
	 * from params completely.
	 */
	 ...
	 *
	 * @param name Key
	 * @param val  Array of value(s) added to the name. NOTE: If val is null or a
	 *             member of val is null, then a corresponding null reference will
	 *             be included when a get method is called on the key later.
	 * @return this
	 */
	...
	/**
	 * Add all of the params provided in the parameter to <em>this</em> params. Any
	 * current value(s) for the same key will be overridden.
	 */
