 ...
 * wrapper around {@link Http2SolrClient}. This is useful when you have multiple
 * Solr servers and the requests need to be Load Balanced among them.
 *
 ...
 *
 * <pre>
 * SolrClient lbHttp2SolrClient = new LBHttp2SolrClient(http2SolrClient, "http://host1:8080/solr/",
 * 		"http://host2:8080/solr", "http://host2:8080/solr");
 * </pre>
 *
