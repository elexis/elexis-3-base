 ...
 * compute a two-dimensional matrix. This class wraps a list so that all data
 * points can be accessed by its coordinates x and y. Where x is the horizontal
 * and y the vertical dimension. x therefore denotes the position of a column
 * whereas y denotes the position of a row. The position computed from the upper
 * left corner starting with (0,0), y denoting the position downwards and x the
