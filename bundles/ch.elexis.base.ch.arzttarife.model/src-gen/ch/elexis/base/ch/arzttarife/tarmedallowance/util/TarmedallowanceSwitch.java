 ...
 * <!-- end-user-doc -->
 * @see ch.elexis.base.ch.arzttarife.tarmedallowance.TarmedallowancePackage
 * @generated
 */
public class TarmedallowanceSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TarmedallowancePackage.ITARMED_ALLOWANCE: {
				ITarmedAllowance iTarmedAllowance = (ITarmedAllowance)theEObject;
				T result = caseITarmedAllowance(iTarmedAllowance);
				if (result == null) result = caseIBillable(iTarmedAllowance);
				if (result == null) result = caseICodeElement(iTarmedAllowance);
				if (result == null) result = caseIdentifiable(iTarmedAllowance);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>ITarmed Allowance</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>ITarmed Allowance</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseITarmedAllowance(ITarmedAllowance object) {
		return null;
	}
