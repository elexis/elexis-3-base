...
public class ElexisPDFGeneratorTest {
	...
	//		ElexisPDFGenerator generator = new ElexisPDFGenerator(billXmlFile, "400_tg_kvg");
	...
	//		assertNotNull(billXmlFile);
	//		AllTests.setOutputDir("output");
	//		ElexisPDFGenerator generator = new ElexisPDFGenerator(billXmlFile, "md_440_tg_kvg_de");
	...
	//		assertNotNull(billXmlFile);
	//		AllTests.setOutputDir("output");
	//		ElexisPDFGenerator generator = new ElexisPDFGenerator(billXmlFile, "440_tp_kvg");
	//		generator.printBill(AllTests.pluginRsc);
	//	}
