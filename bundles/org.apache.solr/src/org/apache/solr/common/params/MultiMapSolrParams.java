...
public class MultiMapSolrParams extends SolrParams {
	...
	/**
	 * Returns a MultiMap view of the SolrParams as efficiently as possible. The
	 * returned map may or may not be a backing implementation.
	 */
	...
	/**
	 * Returns a MultiMap view of the SolrParams. A new map will be created if
	 * newCopy==true
	 */
