 ...
 * standard described at http://www.hl7.ch/default.asp?tab=2&item=standard
 *
 * The org.hl7.v3 helper classes where generated with the metro java (se69 stack
 * (jabx bindings) with the wsdl2java tool and the schema binding file
 * CDABindings.xjb (see content of file at end of class).
 *
 *
...
public class DocboxCDA {
	...
	public enum DOCBOXCDATYPE {
		...
		Docbox_Spital_Anmeldung, Docbox_Spital_Arzt, Docbox_Arzt_Arzt, Docbox_Nachricht
	};
	...
	public POCDMT000040Author getAuthor(String prefix, String given, String family, String mobile, String phone,
			String phoneBusiness, String email, String ean, String docboxId, String userHospitalId) {
	...
	public POCDMT000040Custodian getCustodian(String name, AD addr, String docboxId, String ean, String hospitalId,
			String departmentId) {
	...
	public void addComponentToBody(String title, String text, String docboxSectionCode) {
		POCDMT000040Component3 component = getComponent(stripNonValidXMLCharacters(title), null,
	...
	public POCDMT000040RecordTarget getRecordTarget(String idpatient, String ahv13, String streetAddrLine,
			String postalCode, String city, String phone, String phoneBusiness, String mobile, String email,
			String given, String family, boolean isFemale, boolean isMale, boolean isGenderUnknown, Date birthDate) {
	...
	public POCDMT000040Organization getOrganization(String organizationName, String organizationId,
			String departmentName, String departmentId, String streetAddrLine, String postalCode, String city) {
	...
	public POCDMT000040InformationRecipient getInformationRecipient(String prefix, String given, String family,
			String userDocboxId, POCDMT000040Organization organization) {
		...
		informationRecipient
				.setIntendedRecipient(getIntendedRecipient(prefix, given, family, userDocboxId, organization));
		return informationRecipient;
	}

	public POCDMT000040IntendedRecipient getIntendedRecipient(String prefix, String given, String family,
			String userDocboxId, POCDMT000040Organization organization) {
	...
	public POCDMT000040ClinicalDocument getClinicalDocument(String title, POCDMT000040RecordTarget recordTarget,
			POCDMT000040Author author, POCDMT000040Custodian custodian,
			POCDMT000040InformationRecipient informationRecipient, CE code, String documentId, DOCBOXCDATYPE cdaType) {
	...
	public boolean marshallIntoDom(POCDMT000040IntendedRecipient indendedRecipient, Document document) {
		try {
			Marshaller marshaller = DocboxCDA.getCdaMarshaller();
			marshaller.marshal(new JAXBElement(new QName("urn:hl7-org:v3", "POCDMT000040IntendedRecipient"),
					POCDMT000040IntendedRecipient.class, indendedRecipient), document);
		} catch (Exception e) {
			System.out.println(e);
			return false;
		}
	...
	public POCDMT000040ClinicalDocument unmarshall(String path) {
		try {
			...
			JAXBElement<POCDMT000040ClinicalDocument> doc = unmarshaller.unmarshal(new StreamSource(new File(path)),
	 ...
	 *
	 * @param text [Allgemein|Halbprivat|Privat|Allgemein CH|Selbstzahler]
	 */
	 ...
	 *
	 * @param text [Krankheit|Unfall|Geburt|Mutterschaft|Anderer]
	 */
	public boolean addEinweisungsgrund(String text) {
		if ("Krankheit".equals(text) || "Unfall".equals(text) || "Geburt".equals(text) || "Mutterschaft".equals(text)
				|| "Anderer".equals(text)) {
	 ...
	 *
	 * @param text [ambulant|stationär|kurzstationär]
	 */
	 ...
	 * gemacht wird (Klinik/Datum): String
	 */
	...
	public boolean addGewuenschteLeistung(String nameLeistung, String codeLeistung) {
		listComponent.add(this.getComponent(null, nameLeistung, codeLeistung, getOidDocboxLeistungId()));
		return true;
	}
	...
	/**
	 * Klinische Angaben Schwangerschaft/Stillzeit KSCH
	...
	/**
	 * Klinische Angaben Instrumente KINSTRUMENT Selekion aus Liste: Verfügbare
	...
	/**
	 * Klinische Angaben Lagerung KLAGERUNG Selekion aus Liste: Verfügbare
	...
	/**
	 * Klinische Angaben Anästhesie KANÄSTHESIE Selekion aus Liste: Verfügbare
	...
	/**
	 * Klinische Angaben Bitte zur Anästhesieprechstunde aufbieten
 ...
 * jxb:extensionBindingPrefixes="xjc"> <jxb:bindings schemaLocation="CDA.xsd"
 * node="/xs:schema"> <jxb:bindings
 * node="//xs:complexType[@name='StrucDoc.Text']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings
 * node="//xs:complexType[@name='StrucDoc.Title']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings
 * node="//xs:complexType[@name='StrucDoc.Caption']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings
 * node="//xs:complexType[@name='StrucDoc.Col']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings
 * node="//xs:complexType[@name='StrucDoc.Colgroup']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings
 * node="//xs:complexType[@name='StrucDoc.Content']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings node=
 * "//xs:complexType[@name='StrucDoc.TitleContent']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings
 * node="//xs:complexType[@name='StrucDoc.Footnote']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings node=
 * "//xs:complexType[@name='StrucDoc.TitleFootnote']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings node=
 * "//xs:complexType[@name='StrucDoc.FootnoteRef']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings
 * node="//xs:complexType[@name='StrucDoc.Item']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings
 * node="//xs:complexType[@name='StrucDoc.LinkHtml']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings
 * node="//xs:complexType[@name='StrucDoc.List']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings
 * node="//xs:complexType[@name='StrucDoc.Paragraph']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings node=
 * "//xs:complexType[@name='StrucDoc.RenderMultiMedia']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings
 * node="//xs:complexType[@name='StrucDoc.Table']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings
 * node="//xs:complexType[@name='StrucDoc.Tbody']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings
 * node="//xs:complexType[@name='StrucDoc.Td']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings
 * node="//xs:complexType[@name='StrucDoc.Tfoot']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings
 * node="//xs:complexType[@name='StrucDoc.Th']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings
 * node="//xs:complexType[@name='StrucDoc.Thead']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings
 * node="//xs:complexType[@name='StrucDoc.Tr']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings node=
 * "//xs:complexType[@name='POCD_MT000040.ObservationMedia']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings node=
 * "//xs:complexType[@name='POCD_MT000040.RegionOfInterest']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> <jxb:bindings node=
 * "//xs:complexType[@name='POCD_MT000040.Section']/xs:attribute[@name='ID']">
 * <jxb:property name="attributeId"/> </jxb:bindings> </jxb:bindings>
 * </jxb:bindings>
 */