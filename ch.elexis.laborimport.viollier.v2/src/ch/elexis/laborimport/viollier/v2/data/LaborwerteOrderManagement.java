...
/**
 * JoinTabelle: Für das Viollier Portal muss für jeden Laborwert, eine eindeutige OrderNr definiert
 * sein
 * 
 */
...
public class LaborwerteOrderManagement extends PersistentObject {
	...
	private static final String index1SQL =
		"CREATE INDEX " + TABLENAME + "_idx_labresult on " + TABLENAME + "(" + FLD_LABRESULT_ID + ");"; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
	private static final String index2SQL =
		"CREATE INDEX " + TABLENAME + "_idx_order on " + TABLENAME + "(" + FLD_ORDER_ID + ");"; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
	private static final String index3SQL =
		"CREATE UNIQUE INDEX " + TABLENAME + "_idx_joint on " + TABLENAME + "(" + FLD_LABRESULT_ID + ", " + FLD_ORDER_ID + ");"; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
	...
	public LaborwerteOrderManagement(String laborwertID, String orderNrString){
		create(null);
		set(new String[] {
			FLD_LABRESULT_ID, FLD_ORDER_ID
		}, laborwertID, orderNrString);
	}
	...
	public static String findOrderId(String labResultId){
		Query<LaborwerteOrderManagement> qbe =
			new Query<LaborwerteOrderManagement>(LaborwerteOrderManagement.class);
