...
public interface ClusterStateProvider extends SolrCloseable {
	...
	/**
	 * Given a collection alias, returns a list of collections it points to, or
	 * returns a singleton list of the input if it's not an alias.
	 */
	...
	/**
	 * Given a collection alias, return a single collection it points to, or the
	 * original name if it's not an alias.
	 *
	 * @throws IllegalArgumentException if an alias points to more than 1
