...
public class Preferences extends PreferencePage implements IWorkbenchPreferencePage {
	...
	protected Control createContents(final Composite parent) {
		...
		ports.setText(CoreHub.localCfg.get(PORT, Messages.ReflotronSprintAction_DefaultPort)); // $NON-NLS-1$
		...
		String timeoutStr = CoreHub.localCfg.get(TIMEOUT, Messages.ReflotronSprintAction_DefaultTimeout); // $NON-NLS-1$
