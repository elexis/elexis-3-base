...
public class GDTSatzNachricht6302 extends GDTSatzNachricht {
	...
	/**
	 * Erstellt eine GDT Satzart Nachricht vom Typ "Neue Untersuchung anfordern"
	 * 6302
	 *
	 ...
	 * @param gdtVersion
	 */
	public GDTSatzNachricht6302(String patientenkennung, String nachnamePatient, String vornamePatient,
			...
			String groessePatient, String gewichtPatient, String muttersprachePatient, String guvskf, String testIdent,
...
//		this.testIdent = testIdent;
	...
	/**
	 * Bequemlichkeits Konstruktor für Datensatz 6302 - Beinhaltet nur die MUSS
	 * Felder
	 *
	 * @param patientenkennung
	 * @param nachnamePatient
	 ...
	 */
	GDTSatzNachricht6302(String patientenkennung, String nachnamePatient, String vornamePatient,
		...
		this(patientenkennung, nachnamePatient, vornamePatient, geburtsdatumPatient, null, null, null, null, null, null,
				null, null, null, null, null, null, null, null, null, gdtVersion);
	}
	...
	public static GDTSatzNachricht6302 createfromStringArray(String[] satznachricht) {
		...
		if (satzkennung != GDTConstants.SATZART_UNTERSUCHUNG_ANFORDERN)
			return null;
