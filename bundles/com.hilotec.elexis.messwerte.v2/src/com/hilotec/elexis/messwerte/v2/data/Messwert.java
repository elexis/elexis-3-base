...
public class Messwert extends PersistentObject {
	...
	private static final String index3SQL = "CREATE INDEX idx3 on " + TABLENAME + " (MessungID, Name);";

	private static final String lengthName = "ALTER TABLE " + TABLENAME + " MODIFY Name VARCHAR(255);";
	private static final String lengthWert = "ALTER TABLE " + TABLENAME + " MODIFY Wert VARCHAR(255);";

	private static final String create = "CREATE TABLE " + TABLENAME + " (" + "  ID			VARCHAR(25) PRIMARY KEY, "
			+ "  lastupdate 	BIGINT, " + "  deleted		CHAR(1) DEFAULT '0', " + "  MessungID	VARCHAR(25), "
			+ "  Name			VARCHAR(255), " + "  Wert			VARCHAR(255) " + ");" + "INSERT INTO " + TABLENAME
			+ " (ID, Name) VALUES " + "	('VERSION', '" + VERSION + "');" + index1SQL + index2SQL + index3SQL;
