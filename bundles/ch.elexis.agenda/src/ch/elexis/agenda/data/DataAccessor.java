...
public class DataAccessor implements IDataAccess {
	...
	/**
	 * Returns a list with the defined fields. Currently only "BeiWem" (Bereich) is
	 * supported.
	 */
	public List<Element> getList() {
		...
		ret.add(new IDataAccess.Element(IDataAccess.TYPE.STRING, "Tag", getPlatzhalter(Termin.FLD_TAG), Termin.class,
				1));
		return ret;
	}
	 ...
	 *
	 * @param descriptor      Description of the data
	 * @param dependentObject not used
	 * @param dates           not used
