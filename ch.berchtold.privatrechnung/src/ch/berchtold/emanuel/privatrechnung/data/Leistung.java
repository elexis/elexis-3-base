...
public class Leistung extends VerrechenbarAdapter {
	...
	public static final String XIDDOMAIN = "www.xid.ch/id/customservices/" + CODESYSTEM_NAME;
	...
	private static final String UPDATE_033 = "ALTER TABLE " + TABLENAME + " ADD lastupdate BIGINT;";
	...
	static {
		...
		Xid.localRegisterXIDDomainIfNotExists(XIDDOMAIN, "Privatrechnung B", Xid.ASSIGNMENT_LOCAL);
	}
