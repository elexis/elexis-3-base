...
/**
 * A TupleStream that allows a single Tuple to be pushed back onto the stream
 * after it's been read. This is a useful class when building streams that
 * maintain the order of Tuples between multiple substreams.
 *
 * @since 5.1.0
 **/
...
public class PushBackStream extends TupleStream implements Expressible {
	...
	/**
	 * Return the stream sort - ie, the order in which records are returned This
	 * returns the streamSort of the substream
	 */
