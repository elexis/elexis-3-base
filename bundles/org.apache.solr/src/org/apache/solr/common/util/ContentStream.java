...
public interface ContentStream {
	 ...
	 * is guaranteed to work. The runtime behavior for additional calls is
	 * undefined.
	 *
	 * Note: you must call <code>getStream()</code> or <code>getReader()</code>
	 * before the attributes (name, contentType, etc) are guaranteed to be set.
	 * Streams may be lazy loaded only when this method is called.
	 */
