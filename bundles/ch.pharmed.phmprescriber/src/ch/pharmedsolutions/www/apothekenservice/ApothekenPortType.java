...
public interface ApothekenPortType {
     ...
     * @return
     *     returns https.www_pharmedsolutions_ch.apothekenservice.Apotheken
     */
    ...
    public Apotheken getApotheken(
        @WebParam(name = "ApothekenRequest", targetNamespace = "https://www.pharmedsolutions.ch/ApothekenService", partName = "apothekenrequest")
        ApothekenRequest apothekenrequest);
