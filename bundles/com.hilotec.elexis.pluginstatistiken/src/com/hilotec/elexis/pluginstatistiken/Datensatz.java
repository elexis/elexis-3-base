...
public class Datensatz {
	 ...
	 * @param startDatum Startdatum des Bereichs der als Parameter angegeben wurde.
	 ...
	 * @param source Datenquelle fuer die Spalte; Dabei kann es sich entweder um
	 *               einen Verweis auf eine andere Spalte, oder auf eine
	...
	/**
	 * Internen Datensatz hinzufuegen. Bei Joins, die zu NULL-Werten fuehren, muss
	 * trotzdem ein interner Datensatz angelegt werden mit dem entsprechenden Namen,
	 * und null als ids.
	 *
	 ...
	 * ausgelesen werden, die direkt als Spalte in der Abfrage drin sind anhand des
	 * Namens, als auch Spalten aus anderen Tabellen in der Abfrage, die in der Form
	 * Alias.Spalte angesprochen werden koennen. Alias ist hierbei der Tabellen
	 * Name, der in der Konfiguration als "as" angegeben wurde.
	 *
