...
public class ExtDocSettings {

	public static final String CFG_PATHS_GLOBAL = "ch.elexis.externe_dokumente/paths_global"; //$NON-NLS-1$

	private ExtDocSettings() {
	}
	...
	public static String getPath(String preference) {
		String configured = get(preference);
	...
	public static Optional<File> resolveLocalFile(String pathOrUri) {
		...
		try {
			...
			LoggerFactory.getLogger(ExtDocSettings.class).debug(
