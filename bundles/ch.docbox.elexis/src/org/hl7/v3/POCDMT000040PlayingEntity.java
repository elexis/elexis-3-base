...
/**
 * <p>
 * Java class for POCD_MT000040.PlayingEntity complex type.
 * 
 * <p>
...
@XmlType(name = "POCD_MT000040.PlayingEntity", propOrder = {
	"realmCode", "typeId", "templateId", "code", "quantity", "name", "desc"
})
public class POCDMT000040PlayingEntity {
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any
	 * modification you make to the returned list will be present inside the JAXB object. This is
	 * why there is not a <CODE>set</CODE> method for the quantity property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
