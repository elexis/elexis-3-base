...
public class NeueKonsDialog extends TitleAreaDialog {
	...
	int[] typenI = { KonsData.KONSTYP_NORMAL, KonsData.KONSTYP_TELEFON, KonsData.KONSTYP_HAUSBESUCH, };

	/**
	 * Dialog zum anlegen neuer Kons erstellen.
	 *
	 * @param fall Fall zu dem die Konsultation gehoert
	 * @param typ  Gibt welcher Konsultationstyp als standard benutzt werden soll.
	 */
