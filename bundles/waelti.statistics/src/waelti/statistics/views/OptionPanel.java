...
/**
 * View of the meta model. All label - text field pairs are obtained by
 * reflecting on the given AbtractQuery object. At the moment, all query classes
 * are represented in a map containing an object of each query class. Might be
...
public class OptionPanel extends Composite {
	...
	/**
	 * The query which is selected at the moment and will be configured by the user
	 * input.
	 */
	...
	/**
	 * Normally, a getter should not throw an exception, just return an empty
	 * string. Still, since it is not clear, what the query is, any exception is
	 * caught and just logged.
	 */
