...
/**
 * This suggester produces a DELETEREPLICA request using provided
 * {@link org.apache.solr.client.solrj.cloud.autoscaling.Suggester.Hint#COLL_SHARD}
 * and
 * {@link org.apache.solr.client.solrj.cloud.autoscaling.Suggester.Hint#NUMBER}
 * hints to specify the collection, shard and number of replicas to delete.
 */
		...
		if (!counts.isEmpty()) {
			if (counts.size() > 1) {
				throw new RuntimeException(
						"delete-replica allows at most one number hint specifying the number of replicas to delete");
			}
