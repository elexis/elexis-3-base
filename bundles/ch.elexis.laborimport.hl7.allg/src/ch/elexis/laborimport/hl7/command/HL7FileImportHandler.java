...
public class HL7FileImportHandler extends AbstractHandler implements IHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException{
		...
		String fileUrl =
			event.getParameter("ch.elexis.laborimport.hl7.allg.importFile.fileUrl").toString();
		if (fileUrl.isEmpty()) {
		...
		try {
			...
			ImportFileRunnable runnable =
				new ImportFileRunnable(vfsFile, AutomaticImportService.MY_LAB);
