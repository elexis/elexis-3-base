 ...
 *******************************************************************************/
package ch.elexis.base.codeextension.eigendiagnosen.views;
...
import ch.elexis.base.codeextension.eigendiagnosen.data.Messages;
import ch.elexis.core.ui.UiDesk;
import ch.elexis.core.ui.util.LabeledInputField;
import ch.elexis.core.ui.util.LabeledInputField.InputData;
import ch.elexis.core.ui.views.IDetailDisplay;
import ch.elexis.eigendiagnose.data.Eigendiagnose;
...
public class DetailDisplay implements IDetailDisplay {
	...
	InputData[] data = new InputData[] {
		new InputData(Messages.EigendiagnoseSelector_Shortcut_Label),
		new InputData(Messages.EigendiagnoseSelector_Text_Label),
	};
	Text tComment;
