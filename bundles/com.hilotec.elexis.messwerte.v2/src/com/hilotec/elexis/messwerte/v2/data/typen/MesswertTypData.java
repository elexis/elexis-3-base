...
public class MesswertTypData extends MesswertBase implements IMesswertTyp {
	...
	/**
	 * Liste mit den moeglichen Auswahlen fuer die Combo. Notwendig damit dem Index
	 * beim saveInput() auch wieder der passende Messung zugeordnet werden kann.
	 */
	...
	public Widget createWidget(Composite parent, Messwert messwert) {
		...
		refChoices = Messung.getPatientMessungen(patient, MessungKonfiguration.getInstance().getTypeByName(refType));
