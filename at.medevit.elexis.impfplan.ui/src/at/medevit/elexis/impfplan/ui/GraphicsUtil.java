...
public class GraphicsUtil {
	 public static void drawVerticalText(String string, Display display, int x, int y, GC gc,
	      int style) {
	 ...
	 /**
	   ...
	   * @param style the style (SWT.UP or SWT.DOWN) and (SWT.TOP or SWT.BOTTOM)
	   *          <p>
	   *          Note: Only one of the style UP or DOWN may be specified. The TOP or BOTTOM
	   *          denoty wether y is defined as the source or the target to bound to
	   *          </p>
