...
public class Preferences extends PreferencePage implements IWorkbenchPreferencePage {
	...
	protected Control createContents(final Composite parent) {
		...
		ports.setText(CoreHub.localCfg.get(PORT, Messages.AfinionAS100Action_DefaultPort)); // $NON-NLS-1$
		...
		String timeoutStr = CoreHub.localCfg.get(TIMEOUT, Messages.AfinionAS100Action_DefaultTimeout); // $NON-NLS-1$
		...
		btnApplySentUnits.setSelection(CoreHub.localCfg.get(APPLY_SENT_UNITS, "n").equalsIgnoreCase("y"));
