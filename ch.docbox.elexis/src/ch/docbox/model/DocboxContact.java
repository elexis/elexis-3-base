...
public class DocboxContact extends PersistentObject {
	...
	/**
	 * Create a DocboxContact entry. Does not add same docboxId twice -> if entry for docboxId
	 * should already exist contact reference for this docboxId will be replaced
	 * 
	 * @param docboxId
	 * @param contact
	 */
	public DocboxContact(String docboxId, Kontakt contact){
		...
		if (docboxContact != null) {
			...
			String[] fields = new String[] {
				FLD_DOCBOX_ID, FLD_CONTACT_ID
			};
			
			String[] values = new String[] {
				docboxId, contact.getId()
			};
			set(fields, values);
		}
	}
	 ...
	 * 
	 * @param contact
	 *            {@link Kontakt} which's docboxId you are looking for
	 ...
	 * 
	 * @param docboxId
	 * @return an {@link Kontakt} (or inheriting type {@link Person} or {@link Organisation}). Null
	 *         if none was found.
	 */
