...
public class CertificatesService {
	...
	/**
	 * Use a {@link CovidCertificateApi} instance to get a new vaccination certificate from the rest
	 * API. If ok the {@link Result} contains the uvci of the created {@link CertificateInfo}.
	 * 
	 * 
	 * @param patient
	 * @param model
	...
	/**
	 * Use a {@link CovidCertificateApi} instance to get a new test certificate from the rest API.
	 * If ok the {@link Result} contains the uvci of the created {@link CertificateInfo}.
	 * 
	 * @param patient
	 * @param model
	 * @return
	...
	/**
	 * Use a {@link CovidCertificateApi} instance to revoke a certificate from the rest API.
	 * 
	 * @param model
	 * @return
	 */
	public Result<String> revokeCertificate(IPatient patient, CertificateInfo info,
		RevokeModel model){
