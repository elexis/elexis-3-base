...
public class PhysioSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PhysioPackage.IPHYSIO_LEISTUNG: {
				IPhysioLeistung iPhysioLeistung = (IPhysioLeistung)theEObject;
				T result = caseIPhysioLeistung(iPhysioLeistung);
				if (result == null) result = caseIBillable(iPhysioLeistung);
				if (result == null) result = caseICodeElement(iPhysioLeistung);
				if (result == null) result = caseIdentifiable(iPhysioLeistung);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>IPhysio Leistung</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>IPhysio Leistung</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIPhysioLeistung(IPhysioLeistung object) {
		return null;
	}
