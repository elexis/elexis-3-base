 ...
 * <!-- end-user-doc -->
 * @see ch.elexis.base.ch.arzttarife.nutrition.NutritionPackage
 * @generated
 */
public class NutritionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case NutritionPackage.INUTRITION_LEISTUNG: {
				INutritionLeistung iNutritionLeistung = (INutritionLeistung)theEObject;
				T result = caseINutritionLeistung(iNutritionLeistung);
				if (result == null) result = caseIBillable(iNutritionLeistung);
				if (result == null) result = caseICodeElement(iNutritionLeistung);
				if (result == null) result = caseIdentifiable(iNutritionLeistung);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>INutrition Leistung</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>INutrition Leistung</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseINutritionLeistung(INutritionLeistung object) {
		return null;
	}
