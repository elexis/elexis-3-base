...
/**
 * Interface defining the requirements for the {@link DetailComposite}
 * data-binding
 */
public interface IArtikelstammItem extends IArticle {
	...
	/**
	 * @return the generica type, O if original, G if generica, may be
	 *         <code>null</code>
	 */
	...
	/**
	 *
	 * @return whether this public price is calculated out of the ex-factory price
	 *         plus margin
	 */
	...
	/**
	 * @return the overridden public price value if overridden and not null. If the
	 *         price was not overridden, also <code>null</code> is returned.
	 */
	...
	/**
	 * Restore the original price, if was overridden, effectively deleting a
	 * manually overridden selling price
	 *
	 */
	public void restoreOriginalSellingPrice();

	/**
	 * Restore the original package size, if was overridden, effectively deleting a
	 * manually overridden package size
	 *
	 */
	...
	/**
	 * Override the VatInfo of the item. See . Setting null results in default
	 * {@link VatInfo} for {@link IBillable#getVatInfo()} and false for
	 * {@link IArtikelstammItem#isOverrideVatInfo()}.
	 *
	 * @param vatInfo
	 */
