...
public interface IMesswertTyp {
	/**
	 * @return Feldname des Messwertes (interne Verwendung zum Referenzieren von
	 *         Feldern)
	 */
	...
	/**
	 * Widget fuer die Darstellung des Messwertes im Editieren-Dialog erstellen und
	 * auch glech mit aktuellem Wert befuellen.
	 *
	 * @see saveInput
	 *
	...
	/**
	 * Eingaben im Widget, welches in createWidget erstellt wurde, in den
	 * angegebenen Messwert einfuellen.
	 *
	 * @see createWidget
	 *
	 * @param widget
	 ...
	 * @param pattern
	 *
	 * @return gibt true zurück wenn die Eingabe dem Pattern enspricht, ansonsten
	 *         false
	 */
	...
	/**
	 * @return den gesetzten Wert von isShown. True wenn das Widget angzeigt wird,
	 *         ansonsten false
	 */
