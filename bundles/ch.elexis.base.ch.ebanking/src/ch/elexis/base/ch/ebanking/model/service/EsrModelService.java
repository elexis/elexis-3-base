...
@Component(property = IModelService.SERVICEMODELNAME + "=ch.elexis.base.ch.ebanking.model")
public class EsrModelService extends AbstractModelService implements IModelService, IStoreToStringContribution {
	...
	public Optional<Identifiable> loadFromString(String storeToString) {
		...
		if (storeToString.startsWith("ch.elexis.base.ch.ebanking")) {
	...
	public <T> IQuery<T> getQuery(Class<T> clazz, boolean refreshCache, boolean includeDeleted) {
		return new EsrQuery<>(clazz, refreshCache, (EntityManager) entityManager.getEntityManager(),
				includeDeleted);
	}
