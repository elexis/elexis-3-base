...
/**
 * Encapsulates settings related to SSL Configuration. NOTE: all other settings
 * are ignored if {@link #isSSLMode} is false.
 *
 * @see #setUseSSL
 */
public class SSLConfig {
	...
	/**
	 * NOTE: all other settings are ignored if useSSL is false; trustStore settings
	 * are ignored if clientAuth is false
	 */
	public SSLConfig(boolean useSSL, boolean clientAuth, String keyStore, String keyStorePassword, String trustStore,
	 ...
	 *
	 * if the SSLConfig param is non-null, then this method will return the results
	 * of {@link #createContextFactory()}.
	 *
	 ...
	 * "javax.net.ssl.*" system properties will be used instead, along with
	 ...
	 *
	 * The default implementation generates a simple factory according to the
	 * keystore, truststore, and clientAuth properties of this object.
	 *
	 * @see #getKeyStore
