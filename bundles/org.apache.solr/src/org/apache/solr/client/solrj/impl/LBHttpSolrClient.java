...
/**
 * LBHttpSolrClient or "LoadBalanced HttpSolrClient" is a load balancing wrapper
 * around {@link HttpSolrClient}. This is useful when you have multiple Solr
 * servers and the requests need to be Load Balanced among them.
 *
 * Do <b>NOT</b> use this class for indexing in leader/follower scenarios since
 * documents must be sent to the correct leader; no inter-node routing is done.
 *
 * In SolrCloud (leader/replica) scenarios, it is usually better to use
 * {@link CloudSolrClient}, but this class may be used for updates because the
 * server will forward them to the appropriate leader.
 *
 * <p>
...
public class LBHttpSolrClient extends LBSolrClient {
	 ...
	 *
	 * @deprecated use {@link LBHttpSolrClient#LBHttpSolrClient(Builder)} instead,
	 *             as it is a more extension/subclassing-friendly alternative
	 */
	@Deprecated
	...
	public static class Builder extends SolrClientBuilder<Builder> {
		...
		/**
		 * Provide a Solr endpoint to be used when configuring {@link LBHttpSolrClient}
		 * instances.
		 *
		...
		/**
		 * Provide Solr endpoints to be used when configuring {@link LBHttpSolrClient}
		 * instances.
		 *
		 * Method may be called multiple times. All provided values will be used.
		 *
