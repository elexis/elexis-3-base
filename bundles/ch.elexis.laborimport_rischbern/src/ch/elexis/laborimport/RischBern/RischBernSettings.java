...
public class RischBernSettings {
	...
	public static final String CFG_PATHS_GLOBAL = "rischbern/paths_global"; //$NON-NLS-1$

	private RischBernSettings() {
	}
	...
	public static Optional<File> resolveLocalFile(String pathOrUri) {
		...
		try {
			...
			LoggerFactory.getLogger(RischBernSettings.class).debug(
