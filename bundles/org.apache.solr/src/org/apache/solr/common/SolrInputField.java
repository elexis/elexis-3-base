...
public class SolrInputField implements Iterable<Object>, Serializable {
	...
	/**
	 * Set the value for a field. Arrays will be converted to a collection. If a
	 * collection is given, then that collection will be used as the backing
	...
	/**
	 * Add values to a field. If the added value is a collection, each value will be
	 * added individually.
	 */
	...
	/**
	 * @return the value for this field. If the field has multiple values, this will
	 *         be a collection.
	 */
	...
	/**
	 * @return the values for this field. This will return a collection even if the
