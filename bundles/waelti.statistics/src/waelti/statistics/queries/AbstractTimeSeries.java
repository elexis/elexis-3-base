 ...
 * For a description of the requirements for a query see AbstractQuery.
 *
...
public abstract class AbstractTimeSeries extends AbstractQuery {
	...
	/**
	 * The first date of the calculation period. Default value is the 1.1. of the
	 * actual year.
	 */
	private Calendar startDate = null;
	/**
	 * The last date of the calculation period. Default value is the 31.12. of the
	 * actual year.
	 */
	...
	/**
	 * Initializes the standard data for this query. The standard is the whole
	 * actual year.
	 */
	...
	public void metaSetStartDate(String startDate) throws SetDataException {
		...
		try {
			...
			throw new SetDataException(
					"Anfangsdatum nicht im richtigen Format. " + "Bitte in folgendem Format angeben: dd.mm.yyy");
	...
	/**
	 * Set the end date of this query. Inclusive the given date. The string has to
	 * be in this format: d[d].m[m].yyyy
	 *
	 * @throws SetDataException
	 */
	...
	public void metaSetEndDate(String endDate) throws SetDataException {
		...
		try {
			...
			throw new SetDataException(
					"Enddatum nicht im richtigen Format. " + "Bitte in folgendem Format angeben: dd.mm.yyyy");
		} catch (IllegalArgumentException e) { // illegal date
			throw new SetDataException(
					"Das Enddatum ist kein gültiges Datum. " + "Bitte geben Sie ein gültiges Datum ein.");
		}
		if (cal.compareTo(this.getStartDate()) < 0) {
			throw new SetDataException(
					"Enddatum vor Anfangsdatum. Bitte ändern Sie das Start- " + "oder Enddatum der Auswertung.");
		}
		this.setEndDate(cal);
	}
