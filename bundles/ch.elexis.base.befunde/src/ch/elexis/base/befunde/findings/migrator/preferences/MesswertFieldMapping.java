...
public class MesswertFieldMapping {
	...
	public boolean isValidMapping() {
		boolean fieldsOk = localMesswert != null && localMesswertField != null && findingsCode != null;
		if (fieldsOk) {
	...
	/**
	 * Get a String representing a valid mapping. Not valid mappings return an empty
	 * string.
	 *
	 * @return
	 */
	public String exportToString() {
		...
		if (isValidMapping()) {
			sb.append(MAPPING_TYPE).append(localMesswert).append(MAPPING_FIELD_SEPARATOR).append(localMesswertField);
