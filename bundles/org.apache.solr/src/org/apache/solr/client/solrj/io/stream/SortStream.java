...
public class SortStream extends TupleStream implements Expressible {
	...
	public SortStream(StreamExpression expression, StreamFactory factory) throws IOException {
		...
		init(factory.constructStream(streamExpressions.get(0)), factory.constructComparator(
				((StreamExpressionValue) byExpression.getParameter()).getValue(), FieldComparator.class));
	}
	...
	public Explanation toExplanation(StreamFactory factory) throws IOException {
		...
		return new StreamExplanation(getStreamNodeId().toString())
				...
				.withExpression(toExpression(factory, false).toString()).withHelper(comparator.toExplanation(factory));
	}
