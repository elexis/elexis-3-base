...
/**
 * This is an augmented SolrParams with get/set/add fields for common fields
 * used in the Standard and Dismax request handlers
 *
 *
 * @since solr 1.3
 */
public class SolrQuery extends ModifiableSolrParams {
	public static final String DOCID = "_docid_"; // duplicate of org.apache.solr.search.SortSpecParsing.DOCID which is
	 ...
	 *                  and can't be null
	 * @param intervals Intervals to be used for faceting. It can be an empty array,
	 *                  but it can't be <code>null</code>
	 * @return this
	 */
	 ...
	 *
	 * @param cnt facets having less that cnt hits will be excluded from teh facet
	 *            list
	 */
	 ...
	 * "/select" is assumed.
	 *
	 * @param qt The Request Handler name corresponding to one in solrconfig.xml on
	 *           the server.
	 * @return this
	 */
	 ...
	 * <p>
	 * The item specified can be "anything sortable" by solr; some examples include
	 * a simple field name, the constant string {@code score}, and functions such as
	 * {@code sum(x_f, y_f)}.
	 * <p>
	...
	public static class SortClause implements java.io.Serializable {
		 ...
		 * <p>
		 * The returned string is not suitable for passing to Solr, but may be useful in
		 * debug output and the like.
		 *
