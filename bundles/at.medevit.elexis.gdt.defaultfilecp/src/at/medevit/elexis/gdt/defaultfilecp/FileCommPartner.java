...
public class FileCommPartner {
	...
	private static final String CFG_GDT_FILETRANSFER_GLOBAL = CFG_GDT + "fileTransferSettingsGlobal";
	...
	public FileCommPartner(String id) {
		...
		if (DEFAULT_COMM_PARTNER_ID.equals(id) && !isFileTransferGlobalConfigured()) {
			CoreHubHelper.transformConfigKey("GDT/defaultfilecp/fileTransferDirectory", getFileTransferDirectory(),
					false);
			CoreHubHelper.transformConfigKey("GDT/defaultfilecp/fileTransferDirectory", getFileTransferInDirectory(),
					false);
			CoreHubHelper.transformConfigKey("GDT/defaultfilecp/fileTransferDirectory", getFileTransferOutDirectory(),
					false);
			CoreHubHelper.transformConfigKey("GDT/defaultfilecp/fileTransferUsedType", getFileTransferUsedType(),
					false);
