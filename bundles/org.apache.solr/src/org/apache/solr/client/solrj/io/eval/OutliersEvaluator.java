	...
	public Object doWork(Object... values) throws IOException {
		...
		if (values[1] instanceof List) {
			...
			throw new IOException(
					"The second parameter of the outliers function is the numeric array to be tested for outliers.");
		}
		...
		if (values[2] instanceof Number) {
			...
			throw new IOException(
					"The third parameter of the outliers function is a number for the low outlier threshold.");
		}
		...
		if (values[3] instanceof Number) {
			...
			throw new IOException(
					"The fourth parameter of the outliers function is a number for the high outlier threshold");
		}
		...
		if (values.length == 5) {
			if (values[4] instanceof List) {
				...
				throw new IOException(
						"The optional fifth parameter of the outliers function is an array of Tuples that are paired with the numeric array of values to be tested.");
			}
		} else {
		...
		if (dist instanceof IntegerDistribution) {
			...
			throw new IOException(
					"The first parameter of the outliers function must be a real or integer probability distribution");
		}
	}
}
