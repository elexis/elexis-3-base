...
public class PrinterSettingsDialog extends TitleAreaDialog {
	...
	public PrinterSettingsDialog(Shell parentShell, String printer, String tray) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		setTitle("Pdf Druckereinstellungen");
		setMessage("Bitte Drucker und Druckschacht für den Pdf Rechnungsdruck definieren");
