...
/**
 * Service interface for communication with the ehealth interface provided by
 * the meineimpfungen web service.
 *
...
public interface MeineImpfungenService {
	...
	/**
	 * Get a list of {@link Patient} instances matching name and date of birth of
	 * the provided {@link ch.elexis.data.Patient} from the web service.
	 *
	 * @param elexisPatient
	 * @return
	 */
