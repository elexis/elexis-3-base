...
public class DocboxTerminvereinbarungAction extends DocboxAction {
	...
	public void run(IAction action) {
		try {
			if (CoreHub.getLoggedInContact() != null) {
				...
				if (kontakt != null) {
					Boolean terminvereinbarung = (Boolean) kontakt.getInfoElement("terminvereinbarung");
	...
	private void makeReferral(Kontakt kontakt) {
		...
		POCDMT000040RecordTarget recordTarget = docboxCDA.getRecordTarget(patient.getPatCode(), null,
				...
				null, null, patient.getNatel(), patient.getMailAddress(), patient.getVorname(), patient.getName(),
		...
		if (kontakt != null) {
			informationRecipient = docboxCDA.getInformationRecipient(null, null, null,
