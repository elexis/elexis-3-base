...
public class SolrIntegrationTest {
	...
	public static final String BASE_URL = "https://marcos-mbp-2019.intra.herzpraxis.at/solr/elexis/";
	...
	@BeforeClass
	public static void beforeClass() throws IOException, SQLException, InterruptedException, KeyManagementException,
		...
		IElexisEntityManager entityManager = PortableServiceLoader.get(IElexisEntityManager.class);
		TestDatabaseInitializer testDatabaseInitializer = new TestDatabaseInitializer(
				PortableServiceLoader.getCoreModelService(), entityManager);
