...
public class PdfOptionsDialog extends TitleAreaDialog {
	...
	private static String[] options = new String[] { "Ausgabe auf A4 Seiten aufgeteilt",
			"Ausgabe auf einer PDF-Seite" };
	int selectedIndex = 0;
	...
	public void create() {
		...
		setMessage("Bitte w�hlen Sie die Optionen f�r den PDF Output", IMessageProvider.INFORMATION);
	}
