...
public class InboxPreferences extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public boolean performOk() {
		ConfigServiceHolder.setUser(INBOX_LABRESULT_LBL_CHOOSEN, getListAsString(lvChoosen.getList().getItems()));
		ConfigServiceHolder.setUser(INBOX_LABRESULT_LBL_AVAILABLE, getListAsString(lvAvailable.getList().getItems()));
