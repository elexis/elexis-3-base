...
public interface IGDTCommunicationPartner {
	...
	/**
	 * If the connection type is set to {@link SystemConstants#FILE_COMMUNICATION}
	 * in {@link #getConnectionType()} and the required file type is
	 * {@link GDTConstants#GDT_FILETRANSFER_TYP_FEST} in
	 * {@link #getRequiredFileType()}, a fixed file name for communication has to be
	 * returned here.
	 *
	 * Otherwise this has to be <code>null</code>
	 *
	 * @return the file name to be used (including the prefix <code>.gdt</code>), if
	 *         applicable, else <code>null</code>
	 */
	 ...
	 * @see If no values are given, the 8402 will not be required for successfull
	 *      call of "Neue Untersuchung anfordern"
	 */
	...
	/**
	 * Label denoting the name of the communication partner, has to be < 60 chars
	 * will be used to show to the user and to store as remote identification in the
	 * logfile
	 *
	 * @return
	 */
	...
	/**
	 * The default incoming charset as used by the specific communication partner.
	 * See {@link GDTConstants#ZEICHENSATZ_*}
	 *
	 * If not set {@link GDTConstants#ZEICHENSATZ_IBM_CP_437_CHARSET} is assumed.
	 *
	...
	/**
	 * The default outgoing charset as used by the specific communication partner.
	 * See {@link GDTConstants#ZEICHENSATZ_*}
	 *
	 * If not set, the default charset of the (GDT) system will be used, which is
	 * {@code cp437}. See {@link GDTConstants#ZEICHENSATZ_IBM_CP_437_CHARSET}
	 *
	 * @return int denoting the respective charset, 0 to use system default
	 */
	 ...
	 * partner. This hook can be used, if a certain program needs to be called to
	 * handle the generated GDT Satznachricht.
	 *
	 * If not null this program will be executed any time a message has been written
	 * to this communication partner.
	 *
	...
	/**
	 * Method called before actual output is performed, allowing
	 * {@link GDTSatzNachricht} modification. If values are added
	 * {@link GDTSatzNachricht#setAddAllNotAddedIfSet(boolean)} should be called to
	 * include additional fields in the message.
	 *
