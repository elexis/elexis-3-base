...
public final class PatientBarCodeLabelHandler extends AbstractHandler {
	private static Logger logger = LoggerFactory.getLogger(PatientBarCodeLabelHandler.class);
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		try {
			...
			logger.info("Printing document PatientAddressLabel on printer: " + printerName); //$NON-NLS-1$
