 ...
 * @generated
 */
public class TardocAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected TardocSwitch<Adapter> modelSwitch =
		new TardocSwitch<Adapter>() {
			@Override
			public Adapter caseITardocLeistung(ITardocLeistung object) {
				return createITardocLeistungAdapter();
			}
			@Override
			public Adapter caseITardocExtension(ITardocExtension object) {
				return createITardocExtensionAdapter();
			}
			@Override
			public Adapter caseITardocGroup(ITardocGroup object) {
				return createITardocGroupAdapter();
			}
			@Override
			public Adapter caseITardocKumulation(ITardocKumulation object) {
				return createITardocKumulationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ch.elexis.base.ch.arzttarife.tardoc.ITardocLeistung <em>ITardoc Leistung</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createITardocLeistungAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ch.elexis.base.ch.arzttarife.tardoc.ITardocExtension <em>ITardoc Extension</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createITardocExtensionAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ch.elexis.base.ch.arzttarife.tardoc.ITardocGroup <em>ITardoc Group</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createITardocGroupAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ch.elexis.base.ch.arzttarife.tardoc.ITardocKumulation <em>ITardoc Kumulation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createITardocKumulationAdapter() {
		return null;
	}
