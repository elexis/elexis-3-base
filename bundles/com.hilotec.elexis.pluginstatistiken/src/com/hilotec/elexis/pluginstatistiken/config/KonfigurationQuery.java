...
public class KonfigurationQuery {
	...
	private ITabelle getTabelle(String name) throws PluginstatistikException {
		...
		if (t == null) {
			throw new PluginstatistikException(
					"Abfrage: Unbekannte Tabelle: '" + tabPart + "' (in " + " Datenquelle '" + dqPart + "')");
		}
		return t;
	}
	 ...
	 * @param monitor    Archie-ProgressMonitor der es ermoeglcht, dem Benutzer den
	 *                   auktuellen Status der Abfrage angezeigt werden kann.
	 *
	 ...
	 * angehaengt. Die Funktion arbeitet rekursiv die Liste joinsTodo ab. Bei jedem
	 * Aufruf wird ein Eintrag entfernt bis die Liste leer ist. Die Datensaetze, die
	 * durch die Kette von Joins entstehen werden letztendlich in der Liste result
	 * abgelegt.
	 *
