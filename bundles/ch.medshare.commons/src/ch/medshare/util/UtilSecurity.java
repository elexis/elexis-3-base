...
public class UtilSecurity {
	...
	public static byte[] encryptAsym(String input, Key key)
	...
	public static String decryptAsym(byte[] input, Key key)
			throws GeneralSecurityException, IOException, ClassNotFoundException {
		Cipher cipher = Cipher.getInstance("RSA/NONE/PKCS1PADDING", //$NON-NLS-1$
				getProvider());
	...
	public static byte[] encryptSym(String input, SecretKey key)
			throws GeneralSecurityException, IOException, ClassNotFoundException {
	...
	public static String decryptSym(byte[] input, SecretKey key)
			throws GeneralSecurityException, IOException, ClassNotFoundException {
