...
public interface ILoincCodeService {
	...
	/**
	 * Search for the LOINC code with the matching code attribute and return it.
	...
	/**
	 * Import LOINC code from an InputStream in csv format. The field mapping
	 * specifies how the values from the csv will be mapped.
	 *
	 * <pre>
	...
	/**
	 * Import the data (top 2000 SI LOINC) codes from included csv files, and update
