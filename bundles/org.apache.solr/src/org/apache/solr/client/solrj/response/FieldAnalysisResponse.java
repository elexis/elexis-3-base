 ...
 * {@link org.apache.solr.client.solrj.request.FieldAnalysisRequest}. Holds a
 * map of {@link Analysis} objects per field name as well as a map of
 * {@link Analysis} objects per field type.
 *
 *
 * @since solr 1.4
 */
public class FieldAnalysisResponse extends AnalysisResponseBase {
	...
	public void setResponse(NamedList<Object> response) {
		...
		NamedList<NamedList<NamedList<NamedList<Object>>>> analysisNL = (NamedList<NamedList<NamedList<NamedList<Object>>>>) response
				.get("analysis");
	...
	/**
	 * Returns the analysis for the given field type or {@code null} if no such
	 * analysis exists.
	 *
	...
	/**
	 * Returns the analysis for the given field name or {@code null} if no such
	 * analysis exists.
	 *
	...
	/**
	 * The analysis of a field. Holds a list of all the query time analysis phases
	 * (if a query analysis was requested) as well as index time phases.
	 */
	public static class Analysis {
		 ...
		 *
		 * @return Returns the number of query time analysis phases in this analysis or
		 *         {@code -1} if query time analysis doesn't exist.
		 */
		...
		/**
		 * Returns the query time analysis phases for this analysis or {@code null} if
		 * query time analysis doesn't exist.
		 *
		 *
		 * @return The query time analysis phases for this analysis or {@code null} if
		 *         query time analysis doesn't exist.
		 *
		 */
