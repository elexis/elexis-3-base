...
public class BerchtoldPrivatrechnungTextTemplateRequirement implements ITextTemplateRequirement {
	...
	public static String getBill1Template() {
		...
		return CoreHub.localCfg.get(PreferenceConstants.cfgTemplateBill + "/" + sm.getId(), StringConstants.EMPTY);
	}
	...
	public static String getBill2Template() {
		...
		if (sm == null)
			return StringConstants.EMPTY;
		return CoreHub.localCfg.get(PreferenceConstants.cfgTemplateBill2 + "/" + sm.getId(), StringConstants.EMPTY);
	}
	...
	public static String getESRTemplate() {
		...
		if (sm == null)
			return StringConstants.EMPTY;
		return CoreHub.localCfg.get(PreferenceConstants.cfgTemplateESR + "/" + sm.getId(), StringConstants.EMPTY);
	}
