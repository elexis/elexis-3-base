...
public class StrUtils {
	...
	/**
	 * Splits file names separated by comma character. File names can contain comma
	 * characters escaped by backslash '\'
	 *
	...
	/**
	 * URLEncodes a value, replacing only enough chars so that the URL may be
	 * unambiguously pasted back into a browser.
	 * <p>
	...
	/**
	 * writes chars from item to out, backslash escaping as needed based on
	 * separator -- but does not append the separator itself
	 */
