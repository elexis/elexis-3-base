...
public class RecurringAppointmentDialog extends TitleAreaDialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		ContentProposalAdapter cppa = new ContentProposalAdapter(txtContactSearch, new TextContentAdapter(), aopp, null,
				null);
		...
		cppa.addContentProposalListener(new IContentProposalListener() {
			...
			public void proposalAccepted(IContentProposal proposal) {
				IdentifiableContentProposal<IContact> prop = (IdentifiableContentProposal<IContact>) proposal;
	...
	private void updateModel() {
		...
		case DAILY:
			...
			case AFTER_N_OCCURENCES:
				...
				break;
			case ON_SPECIFIC_DATE:
				appointment.setSeriesPatternString(dateFormatter.format(appointment.getSeriesEndDate()));
				break;
			}
			break;
		case WEEKLY:
		...
		case YEARLY:
			appointment
					.setSeriesPatternString(decimalFormat.format(ysc.getDay()) + decimalFormat.format(ysc.getMonth()));
			break;
		default:
			break;
		}
		...
		case AFTER_N_OCCURENCES:
			...
			break;
		case ON_SPECIFIC_DATE:
			appointment.setEndingPatternString(dateFormatter.format(appointment.getSeriesEndDate()));
			break;
		}
	}
	...
	private boolean txtDataIsMatchingContact() {
		return txtContactSearch.getData() instanceof IContact
				&& ((IContact) txtContactSearch.getData()).getLabel().equals(txtContactSearch.getText());
	}
}
