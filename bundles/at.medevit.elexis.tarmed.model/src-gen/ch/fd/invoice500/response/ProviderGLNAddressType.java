...
/**
 * <p>Java-Klasse für providerGLNAddressType complex type.
 * 
 ...
 *       &lt;attribute name="gln_location" use="required" type="{http://www.forum-datenaustausch.ch/invoice}glnPartyType" /&gt;
...
@XmlType(name = "providerGLNAddressType", propOrder = {
    "company",
    "person"
})
public class ProviderGLNAddressType {

    protected CompanyType company;
    protected PersonType person;
    @XmlAttribute(name = "gln", required = true)
    protected String gln;
    @XmlAttribute(name = "gln_location", required = true)
    protected String glnLocation;
    ...
    /**
     * Ruft den Wert der glnLocation-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getGlnLocation() {
        return glnLocation;
    }

    /**
     * Legt den Wert der glnLocation-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setGlnLocation(String value) {
        this.glnLocation = value;
    }
