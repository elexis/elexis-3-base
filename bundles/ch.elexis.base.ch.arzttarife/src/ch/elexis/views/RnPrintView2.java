	...
	private String getTemplateUrl(String name) {
		if (isWord()) {
			...
			case TarmedTemplateRequirement.TT_TARMED_S1:
				return URL_ROOT + "Tarmedrechnung_S1_01.docx";
			case TarmedTemplateRequirement.TT_TARMED_S2:
				return URL_ROOT + "Tarmedrechnung_S2_01.docx";
			...
			switch (name) {
			case TarmedTemplateRequirement.TT_TARMED_S1:
				return URL_ROOT + "Tarmedrechnung_S1.odt";
			case TarmedTemplateRequirement.TT_TARMED_S2:
				return URL_ROOT + "Tarmedrechnung_S2.odt";
			case TarmedTemplateRequirement.TT_TARMED_44_S1:
