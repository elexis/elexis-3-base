...
public class RfeAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected RfeSwitch<Adapter> modelSwitch =
		new RfeSwitch<Adapter>() {
			@Override
			public Adapter caseIReasonForEncounter(IReasonForEncounter object) {
				return createIReasonForEncounterAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ch.elexis.base.ch.arzttarife.rfe.IReasonForEncounter <em>IReason For Encounter</em>}'.
	 * <!-- begin-user-doc -->
