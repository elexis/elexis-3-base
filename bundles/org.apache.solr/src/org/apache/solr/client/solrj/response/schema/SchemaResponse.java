...
/**
 * This class is used to wrap the response messages retrieved from Solr Schema
 * API.
 *
...
public class SchemaResponse extends SolrResponseBase {
	...
	@SuppressWarnings("unchecked")
	private static void fillFieldTypeDefinition(FieldTypeDefinition fieldTypeDefinition,
	...
	private static SchemaRepresentation createSchemaConfiguration(@SuppressWarnings({ "rawtypes" }) Map schemaObj) {
	...
	@SuppressWarnings("unchecked")
	private static List<Map<String, Object>> getFields(@SuppressWarnings({ "rawtypes" }) Map schemaNamedList) {
	...
	@SuppressWarnings("unchecked")
	private static List<Map<String, Object>> getDynamicFields(@SuppressWarnings({ "rawtypes" }) Map schemaNamedList) {
	...
	@SuppressWarnings("unchecked")
	private static List<Map<String, Object>> getCopyFields(@SuppressWarnings({ "rawtypes" }) Map schemaNamedList) {
