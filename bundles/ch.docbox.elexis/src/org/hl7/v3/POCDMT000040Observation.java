...
@XmlType(name = "POCD_MT000040.Observation", propOrder = { "realmCode", "typeId", "templateId", "id", "code",
		"derivationExpr", "text", "statusCode", "effectiveTime", "priorityCode", "repeatNumber", "languageCode",
		"value", "interpretationCode", "methodCode", "targetSiteCode", "subject", "specimen", "performer", "author",
...
public class POCDMT000040Observation {
	 ...
	 * Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
	 * for the interpretationCode property.
	 *
	 * <p>
	 * For example, to add a new item, do as follows:
	 *
	 ...
	 *
	 * @param value allowed object is {@link XActMoodDocumentObservation }
	 *
	 */
