...
public class Preferences extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public Preferences(){
		super(Messages.CobasMiraAction_ButtonName); //$NON-NLS-1$
	...
	protected Control createContents(final Composite parent){
		...
		lblLabIdentification.setText(Messages.Preferences_LabIdentification); //$NON-NLS-1$
		...
		lblIgnoreUser.setText(Messages.Preferences_IgnoreUserOnInput); //$NON-NLS-1$
		lblIgnoreUser.setLayoutData(new GridData(SWT.NONE));
		String controlUserStr =
			CoreHub.localCfg.get(CONTROLUSER,
				Messages.CobasMiraAction_DefaultIgnoreUser); //$NON-NLS-1$
		...
		btnBrowse.setText(Messages.Preferences_btnBrowse_text); //$NON-NLS-1$
		...
		ports
			.setText(CoreHub.localCfg.get(PORT, Messages.CobasMiraAction_DefaultPort)); //$NON-NLS-1$	
		...
		lblDatabits.setText(Messages.Preferences_Databits); //$NON-NLS-1$
		...
		lblStopbits.setText(Messages.Preferences_Stopbits); //$NON-NLS-1$
