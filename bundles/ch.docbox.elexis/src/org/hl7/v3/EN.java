...
public class EN {
	...
	@XmlElementRefs({ @XmlElementRef(name = "suffix", namespace = "urn:hl7-org:v3", type = JAXBElement.class),
	 ...
	 * Tahoe", etc. An entity name may be as simple as a character string or may
	 * consist of several entity name parts, such as, "Jim", "Bob", "Walton", and
	 * "Jr.", "Health Level Seven" and "Inc.", "Lake" and "Tahoe". Gets the value of
	 ...
	 * }{@code <} {@link EnSuffix }{@code >} {@link JAXBElement
	 * }{@code <}{@link EnDelimiter }{@code >} {@link JAXBElement
	 * }{@code <}{@link IVLTS }{@code >} {@link JAXBElement }{@code <}
	 * {@link EnFamily }{@code >} {@link JAXBElement }{@code <}{@link EnPrefix
	 * }{@code >} {@link JAXBElement }{@code <}{@link EnGiven }{@code >}
	 * {@link String }
	 *
	 *
	 */
