...
public class DataAccessor implements IDataAccess {
	private static final String[] fields = { "JetzigesLeiden", "JetzigesLeidenICPC", "AllgStatus", "LokStatus",
			"Prozedere", "ProzedereICPC", "Diagnose", "DiagnoseICPC" };
	...
	private Result<Object> generiereDiagnoseliste(Patient pat) {
		...
		// muessten.
		DiagnoselisteItem root = DiagnoselisteItem.getRoot(pat, DiagnoselisteItem.TYP_DIAGNOSELISTE);
	...
	public Result<Object> getObject(String descriptor, PersistentObject dependentObject, String dates,
		...
		return new Result<Object>(Result.SEVERITY.ERROR, IDataAccess.INVALID_PARAMETERS, "Ungültiges Feld",
				dependentObject, true);
	}
