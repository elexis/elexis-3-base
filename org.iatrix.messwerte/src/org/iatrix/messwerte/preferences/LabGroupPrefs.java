...
/**
 * This class is a copy of ch.elexis.preferences.LabGroupPrefs. Up to Elexis 1.3.4,
 * ch.elexis.preferences.LabGroupPrefs, is not this user-friendly. Therefore, we created our own
 * version. This code will be part of Elexis 1.4.
 * 
	...
	protected Control createContents(Composite parent){
		...
		renameButton.addSelectionListener(new SelectionListener() {
			public void widgetSelected(SelectionEvent e){
				if (actGroup != null) {
					InputDialog dlg =
						new InputDialog(getShell(), "Gruppe umbenennen",
							"Bitte geben Sie den neuen Namen der Gruppe ein.", actGroup.getName(),
							null);
