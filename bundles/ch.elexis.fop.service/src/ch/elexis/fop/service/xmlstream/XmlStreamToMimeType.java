...
public class XmlStreamToMimeType {
	private static Logger logger = LoggerFactory.getLogger(XmlStreamToMimeType.class);
	private static XmlStreamToMimeType instance;

	private XmlStreamToMimeType() {

	}

	public static XmlStreamToMimeType getInstance() {
		if (instance == null)
			instance = new XmlStreamToMimeType();
		return instance;
	}
	 ...
	 * @param resolver
	 */
	public void transform(InputStream xmlStream, InputStream xslt, OutputStream outputStream, String outputFormat,
