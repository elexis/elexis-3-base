...
/**
 * Performs the vaccination conversion. Converts vaccinations from
 * ch.elexis.impfplan to vaccinations of this plugin. This class is only usable
 * if the optional ch.elexis.impflan dependency is resolvable.
 *
 * @author Lucia
 *
 */
public class ImportLegacyVaccinationsProgress implements IRunnableWithProgress {
	 ...
	 * Constructor
	 *
	 * @param administrator the doctor to use as administrator of all the
	 *                      vaccinations that will be imported
	 */
	...
	public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
		...
		Query<ch.elexis.impfplan.model.Vaccination> qbe = new Query<>(ch.elexis.impfplan.model.Vaccination.class);
		...
		for (ch.elexis.impfplan.model.Vaccination vacc : list) {
			...
			// create vaccination
			Vaccination v = new Vaccination(patId, null, vaccName, null, null, doa, null, administrator);
	...
	/**
	 * Feedback whether the import completed normal or there where any specially
	 * handled vaccinations
	 *
	...
	/**
	 * Provides knowledge about all failed to import
	 * {@link ch.elexis.impfplan.model.Vaccination}s with the belonging
	 * {@link ErrorCode}
	 *
	 ...
	 *
	 * @param patId Id of the patient the vaccination was given to
	 * @param vacc  the vaccination itself
