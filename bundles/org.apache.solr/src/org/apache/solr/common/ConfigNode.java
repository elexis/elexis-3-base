...
/**
 * A generic interface that represents a config file, mostly XML Please note
 * that this is an immutable, read-only object.
 */
public interface ConfigNode {
	...
	/**
	 * Child by name or return an empty node if null if there are multiple values ,
	 * it returns the first elem This never returns a null
	 */
