...
public class GDTSatzNachricht6301 extends GDTSatzNachricht {
	 ...
	 */
	public GDTSatzNachricht6301(String patientenkennung, String nachnamePatient,
	...
	/**
	 * Bequemlichkeits Konstruktor für Datensatz 6301 - Beinhaltet nur die MUSS Felder
	 * 
	 * @param patientenkennung
	 * @param nachnamePatient
	 * @param vornamePatient
	 ...
	 * @param gdtVersion - default: {@link GDTConstants#GDT_VERSION}
	 */
	GDTSatzNachricht6301(String patientenkennung, String nachnamePatient, String vornamePatient, String geburtsdatumPatient, String gdtVersion) {
		this(patientenkennung, nachnamePatient, vornamePatient, geburtsdatumPatient, 
			null, null, null, null, null, null, null, null, null, null, null, null, null, gdtVersion);
	}
	...
	public static GDTSatzNachricht6301 createfromStringArray(String[] satznachricht){
		...
		if(satzkennung!=GDTConstants.SATZART_STAMMDATEN_UEBERMITTELN) return null;
		...
		return new GDTSatzNachricht6301(ds.get(GDTConstants.FELDKENNUNG_PATIENT_KENNUNG), 
			...
			ds.get(GDTConstants.FELDKENNUNG_PATIENT_MUTTERSPRACHE), ds.get(GDTConstants.FELDKENNUNG_GDT_ID_EMPFAENGER), 
