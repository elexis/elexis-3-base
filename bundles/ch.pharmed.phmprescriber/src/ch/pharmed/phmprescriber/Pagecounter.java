...
class Pagecounter implements Printable {
	...
	public int print(Graphics g, PageFormat pageFormat, int page) throws PrinterException {
		...
		// ======================================================================================================//
		// This procedure will simply measure, how many we have to print and which
		// products belong to which page
		// Algorithm: (1) Measure the header and the footer to determine the area where
		// to print the products
		// (2) check, how many pages we need based on this area then productsnames with
		// remarks
		// Info: This procedure is necessary, as java.awt.print needs to know the page
		// number before showing the
		// print dialog...
		// ======================================================================================================//
		...
		for (int i = 0; i < rp.getLines().size(); i = i + 1) {
			...
			// If the last item will touch the limit, assign the (real) last item to the
			// indices, reset the measurer and run the current loop again
			if (areaHeight < intMeasureY) {
