...
public class RangeFacetMap extends JsonFacetMap<RangeFacetMap> {
	...
	/**
	 * Indicates whether the facet's last bucket should stop exactly at {@code end},
	 * or be extended to be {@code gap} wide
	 *
	 * Defaults to false if not specified.
	 *
	 * @param hardEnd true if the final bucket should be truncated at {@code end};
	 *                false otherwise
	 */
	...
	/**
	 * Indicates that an additional range bucket(s) should be computed and added to
	 * those computed for {@code start} and {@code end}
	 *
	...
	/**
	 * Indicates that buckets should be returned only if they have a count of at
	 * least {@code minOccurrences}
	 *
