...
public class GDTSatzNachricht6300 extends GDTSatzNachricht {
	 ...
	 */
	public GDTSatzNachricht6300(String patientenkennung, String gdtIdReceiver, String gdtIdSender, String zeichensatz,
			String gdtVersion) {
...
//		this.patientenkennung = patientenkennung;
	...
	/**
	 * Bequemlichkeits Konstruktor für Datensatz 6300 - Beinhaltet nur die MUSS
	 * Felder
	 *
	...
	public static GDTSatzNachricht6300 createfromStringArray(String[] satznachricht) {
		...
		if (satzkennung != GDTConstants.SATZART_STAMMDATEN_ANFORDERN)
			return null;
