...
public interface CommonParams {
	...
	Set<String> ADMIN_PATHS = Collections.unmodifiableSet(new HashSet<>(Arrays.asList(CORES_HANDLER_PATH,
			COLLECTIONS_HANDLER_PATH, HEALTH_CHECK_HANDLER_PATH, CONFIGSETS_HANDLER_PATH, SYSTEM_INFO_PATH, AUTHC_PATH,
			AUTHZ_PATH, METRICS_PATH, METRICS_HISTORY_PATH, AUTOSCALING_PATH, AUTOSCALING_HISTORY_PATH,
			AUTOSCALING_DIAGNOSTICS_PATH, AUTOSCALING_SUGGESTIONS_PATH)));
