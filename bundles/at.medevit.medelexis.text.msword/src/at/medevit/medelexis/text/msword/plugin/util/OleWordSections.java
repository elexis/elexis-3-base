...
public class OleWordSections extends OleWrapper {
	public OleWordSections(OleAutomation oleAuto, Display display, OleWrapperManager manager) {
	...
	public OleWordSection getItem(int index, OleWrapperManager manager) {
		...
		oleVar.dispose();
		arguments[0].dispose();
		return new OleWordSection(oleAuto, display, manager);
	}
