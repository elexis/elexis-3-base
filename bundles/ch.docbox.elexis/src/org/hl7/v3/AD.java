...
/**
 * 
 * Mailing and home or office addresses. A sequence of address parts, such as street or post office
 * Box, city, postal code, country, etc.
 * 
 * 
 * <p>
...
public class AD {
	...
	/**
	 * 
	 * Mailing and home or office addresses. A sequence of address parts, such as street or post
	 * office Box, city, postal code, country, etc. Gets the value of the content property.
	 * 
	 * <p>
	 ...
	 * {@link AdxpAdditionalLocator }{@code >} {@link JAXBElement }{@code <}{@link AdxpPostBox }
	 * {@code >} {@link JAXBElement }{@code <}{@link AdxpHouseNumber }{@code >} {@link JAXBElement }
	 * {@code <}{@link AdxpStreetNameType }{@code >} {@link JAXBElement }{@code <}
	 * {@link AdxpDeliveryAddressLine }{@code >} {@link JAXBElement }{@code <}{@link AdxpCounty }
	 * {@code >} {@link JAXBElement }{@code <}{@link AdxpDirection }{@code >} {@link JAXBElement }
	 * {@code <}{@link AdxpPrecinct }{@code >} {@link JAXBElement }{@code <}{@link AdxpDelimiter }
	 * {@code >} {@link JAXBElement }{@code <}{@link AdxpState }{@code >} {@link JAXBElement }{@code <}
	 * {@link AdxpDeliveryInstallationQualifier }{@code >} {@link JAXBElement }{@code <}
	 * {@link AdxpCity }{@code >} {@link JAXBElement }{@code <}{@link AdxpBuildingNumberSuffix }
	 * {@code >} {@link JAXBElement }{@code <}{@link AdxpDeliveryInstallationType }{@code >}
	 * {@link JAXBElement }{@code <}{@link AdxpUnitID }{@code >} {@link JAXBElement }{@code <}
	 * {@link AdxpPostalCode }{@code >} {@link JAXBElement }{@code <}{@link AdxpDeliveryMode }{@code >}
	 * {@link JAXBElement }{@code <}{@link AdxpStreetNameBase }{@code >} {@link JAXBElement }{@code <}
	 * {@link AdxpDeliveryInstallationArea }{@code >} {@link JAXBElement }{@code <}
	 * {@link AdxpDeliveryModeIdentifier }{@code >} {@link JAXBElement }{@code <}
	 * {@link AdxpCensusTract }{@code >} {@link JAXBElement }{@code <}{@link AdxpStreetAddressLine }
	 * {@code >} {@link JAXBElement }{@code <}{@link AdxpCareOf }{@code >} {@link JAXBElement }{@code <}
	 * {@link SXCMTS }{@code >} {@link JAXBElement }{@code <}{@link AdxpHouseNumberNumeric }{@code >}
	 * {@link JAXBElement }{@code <}{@link AdxpStreetName }{@code >} {@link JAXBElement }{@code <}
	 * {@link AdxpUnitType }{@code >} {@link String } {@link JAXBElement }{@code <}{@link AdxpCountry }
	 * {@code >}
	 * 
	 * 
	 */
