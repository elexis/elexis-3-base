 ...
 * or service) mediated by telecommunication equipment. The address is specified as a Universal
 * Resource Locator (URL) qualified by time specification and use codes that help in deciding which
...
public class TEL extends URL {
	 ...
	 * why there is not a <CODE>set</CODE> method for the useablePeriod property.
	 * 
	 * <p>
