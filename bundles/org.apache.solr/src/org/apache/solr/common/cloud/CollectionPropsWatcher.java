 ...
 * {@link ZkStateReader#registerCollectionPropsWatcher(String, CollectionPropsWatcher)}
 * and called whenever the collection properties change.
 */
public interface CollectionPropsWatcher {

	/**
	 * Called when the collection properties we are registered against has a change
	 * of state
	 *
