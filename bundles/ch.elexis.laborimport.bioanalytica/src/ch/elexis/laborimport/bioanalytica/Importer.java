...
public class Importer extends ImporterPage {
	...
	private Result importDirect() {
		...
		if (downloadDir.isDirectory()) {
			...
			result = new Result<String>(Result.SEVERITY.ERROR, 1, MY_LAB, "Fehlerhafte Konfiguration", true);
		}
		// }
	...
	public IStatus doImport(IProgressMonitor monitor) throws Exception {
		...
		if (type == FILE) {
			...
			return ResultAdapter.getResultAsStatus(hlp.importFile(new File(filename), null, new Groups(), false));
		} else {
