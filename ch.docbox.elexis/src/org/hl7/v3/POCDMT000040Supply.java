...
@XmlType(name = "POCD_MT000040.Supply", propOrder = {
	...
	"priorityCode", "repeatNumber", "independentInd", "quantity", "expectedUseTime", "subject",
	"specimen", "product", "performer", "author", "informant", "participant", "entryRelationship",
...
public class POCDMT000040Supply {
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any
	 * modification you make to the returned list will be present inside the JAXB object. This is
	 * why there is not a <CODE>set</CODE> method for the effectiveTime property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any
	 * modification you make to the returned list will be present inside the JAXB object. This is
	 * why there is not a <CODE>set</CODE> method for the priorityCode property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link POCDMT000040Product }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link ActClassSupply }
	 * 
	 */
