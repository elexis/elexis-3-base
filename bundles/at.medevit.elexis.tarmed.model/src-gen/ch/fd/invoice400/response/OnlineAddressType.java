 ...
 *           &lt;simpleType>
 *             &lt;restriction base="{http://www.xmlData.ch/xmlInvoice/XSD}stringType1_70">
 *               &lt;pattern value=".+@.+"/>
 *             &lt;/restriction>
 *           &lt;/simpleType>
 *         &lt;/element>
...
public class OnlineAddressType {
	 ...
	 * why there is not a <CODE>set</CODE> method for the email property.
	 * 
	 * <p>
	 ...
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any
	 * modification you make to the returned list will be present inside the JAXB object. This is
	 * why there is not a <CODE>set</CODE> method for the url property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
