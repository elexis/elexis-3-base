...
import ch.elexis.core.jpa.entities.InboxElement;
...
public class ElexisTypeMap {
	...
	public static final String TYPE_INBOXELEMENT = "at.medevit.elexis.inbox.model.InboxElement"; //$NON-NLS-1$
	...
	static {
		...
		stsToClassMap.put(TYPE_INBOXELEMENT, InboxElement.class);
		classToStsMap.put(InboxElement.class, TYPE_INBOXELEMENT);
	}
