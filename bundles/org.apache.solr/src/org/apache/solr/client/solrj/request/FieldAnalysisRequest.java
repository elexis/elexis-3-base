...
public class FieldAnalysisRequest extends SolrRequest<FieldAnalysisResponse> {
	...
	/**
	 * Sets the query to be analyzed. May be {@code null} indicated that no query
	...
	/**
	 * Returns a list of field names the analysis should be performed on. May return
	 * {@code null} indicating that no analysis will be performed on field names.
	 *
	...
	/**
	 * Returns a list of field types the analysis should be performed on. May return
	 * {@code null} indicating that no analysis will be peformed on field types.
	 *
